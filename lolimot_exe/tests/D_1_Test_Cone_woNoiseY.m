function res = D_1_Test_Cone_woNoiseY(x)
Ei = zeros(1, 30);
Li = zeros(1,30);
 U = 0.0;
 V = 0.0;
...
%% Measure - [0.042855 4.24264]
 ...
 dV = 0.0;
 dV = dV - ((x(2) - -2.76) / 0.0111514) * Ei(1);
 dV = dV - ((x(2) - -2.64) / 0.0250906) * Ei(2);
 dV = dV - ((x(2) - -0.84) / 0.178422) * Ei(3);
 dV = dV - ((x(2) - 1.32) / 0.100362) * Ei(4);
 dV = dV - ((x(2) - 0.696) / 0.0642318) * Ei(5);
 dV = dV - ((x(2) - 2.136) / 0.144522) * Ei(6);
 dV = dV - ((x(2) - -0.84) / 0.401449) * Ei(7);
 dV = dV - ((x(2) - -1.608) / 0.00713687) * Ei(8);
 dV = dV - ((x(2) - 0.696) / 0.0642318) * Ei(9);
 dV = dV - ((x(2) - 2.136) / 0.144522) * Ei(10);
 dV = dV - ((x(2) - -1.992) / 0.016058) * Ei(11);
 dV = dV - ((x(2) - 0.696) / 0.0642318) * Ei(12);
 dV = dV - ((x(2) - -0.84) / 0.178422) * Ei(13);
 dV = dV - ((x(2) - -2.16) / 0.0250906) * Ei(14);
 dV = dV - ((x(2) - -1.0128) / 0.0924939) * Ei(15);
 dV = dV - ((x(2) - 2.136) / 0.144522) * Ei(16);
 dV = dV - ((x(2) - -2.16) / 0.0250906) * Ei(17);
 dV = dV - ((x(2) - 2.52) / 0.0446054) * Ei(18);
 dV = dV - ((x(2) - 0.1392) / 0.0411084) * Ei(19);
 dV = dV - ((x(2) - -1.992) / 0.016058) * Ei(20);
 dV = dV - ((x(2) - -2.76) / 0.0111514) * Ei(21);
 dV = dV - ((x(2) - 2.136) / 0.144522) * Ei(22);
 dV = dV - ((x(2) - -0.552) / 0.256927) * Ei(23);
 dV = dV - ((x(2) - -2.16) / 0.0250906) * Ei(24);
 dV = dV - ((x(2) - -0.648) / 0.11419) * Ei(25);
 dV = dV - ((x(2) - -0.552) / 0.256927) * Ei(26);
 dV = dV - ((x(2) - 1.32) / 0.100362) * Ei(27);
 dV = dV - ((x(2) - -2.76) / 0.0111514) * Ei(28);
 dV = dV - ((x(2) - -2.16) / 0.0250906) * Ei(29);
 dV = dV - ((x(2) - 2.136) / 0.144522) * Ei(30);
 ...
 dU = 0.0;
 dU = dU + (-0.72087 - ((x(2) - -2.76) / 0.0111514) * Li(1)) * Ei(1);
 dU = dU + (-0.817762 - ((x(2) - -2.64) / 0.0250906) * Li(2)) * Ei(2);
 dU = dU + (-0.331011 - ((x(2) - -0.84) / 0.178422) * Li(3)) * Ei(3);
 dU = dU + (0.830828 - ((x(2) - 1.32) / 0.100362) * Li(4)) * Ei(4);
 dU = dU + (0.245693 - ((x(2) - 0.696) / 0.0642318) * Li(5)) * Ei(5);
 dU = dU + (0.62503 - ((x(2) - 2.136) / 0.144522) * Li(6)) * Ei(6);
 dU = dU + (-0.624699 - ((x(2) - -0.84) / 0.401449) * Li(7)) * Ei(7);
 dU = dU + (-0.843472 - ((x(2) - -1.608) / 0.00713687) * Li(8)) * Ei(8);
 dU = dU + (0.440825 - ((x(2) - 0.696) / 0.0642318) * Li(9)) * Ei(9);
 dU = dU + (0.723978 - ((x(2) - 2.136) / 0.144522) * Li(10)) * Ei(10);
 dU = dU + (-0.687386 - ((x(2) - -1.992) / 0.016058) * Li(11)) * Ei(11);
 dU = dU + (0.887686 - ((x(2) - 0.696) / 0.0642318) * Li(12)) * Ei(12);
 dU = dU + (-0.888176 - ((x(2) - -0.84) / 0.178422) * Li(13)) * Ei(13);
 dU = dU + (-0.625282 - ((x(2) - -2.16) / 0.0250906) * Li(14)) * Ei(14);
 dU = dU + (-0.450174 - ((x(2) - -1.0128) / 0.0924939) * Li(15)) * Ei(15);
 dU = dU + (0.820673 - ((x(2) - 2.136) / 0.144522) * Li(16)) * Ei(16);
 dU = dU + (-0.736364 - ((x(2) - -2.16) / 0.0250906) * Li(17)) * Ei(17);
 dU = dU + (0.819294 - ((x(2) - 2.52) / 0.0446054) * Li(18)) * Ei(18);
 dU = dU + (0.0719228 - ((x(2) - 0.1392) / 0.0411084) * Li(19)) * Ei(19);
 dU = dU + (-0.912237 - ((x(2) - -1.992) / 0.016058) * Li(20)) * Ei(20);
 dU = dU + (-0.85395 - ((x(2) - -2.76) / 0.0111514) * Li(21)) * Ei(21);
 dU = dU + (0.945357 - ((x(2) - 2.136) / 0.144522) * Li(22)) * Ei(22);
 dU = dU + (-0.500821 - ((x(2) - -0.552) / 0.256927) * Li(23)) * Ei(23);
 dU = dU + (-0.822611 - ((x(2) - -2.16) / 0.0250906) * Li(24)) * Ei(24);
 dU = dU + (-0.552661 - ((x(2) - -0.648) / 0.11419) * Li(25)) * Ei(25);
 dU = dU + (-0.433307 - ((x(2) - -0.552) / 0.256927) * Li(26)) * Ei(26);
 dU = dU + (0.536205 - ((x(2) - 1.32) / 0.100362) * Li(27)) * Ei(27);
 dU = dU + (-0.995116 - ((x(2) - -2.76) / 0.0111514) * Li(28)) * Ei(28);
 dU = dU + (-0.97762 - ((x(2) - -2.16) / 0.0250906) * Li(29)) * Ei(29);
 dU = dU + (0.989991 - ((x(2) - 2.136) / 0.144522) * Li(30)) * Ei(30);
  clear Ei;
  clear Li;
    res = ((dU*V-dV*U)/(V*V));
