...
using namespace std;
extern "C" double D_0_Test_Cone_woNoiseY(vector<double> & x)
{
double Result;
vector<double> Ei(30);
vector<double> Li(30);
...
// Measure - [0.042855 4.24264]
 ...
 dV = 0.0;
 dV += - ((x[0] - -2.64) / (double)0.0250906) * Ei[0];
 dV += - ((x[0] - 1.8) / (double)0.278784) * Ei[1];
 dV += - ((x[0] - -2.28) / (double)0.100362) * Ei[2];
 dV += - ((x[0] - 0.84) / (double)0.0111514) * Ei[3];
 dV += - ((x[0] - -2.64) / (double)0.0250906) * Ei[4];
 dV += - ((x[0] - -2.64) / (double)0.0250906) * Ei[5];
 dV += - ((x[0] - 0.648) / (double)0.000446055) * Ei[6];
 dV += - ((x[0] - -0.912) / (double)0.0812934) * Ei[7];
 dV += - ((x[0] - -1.416) / (double)0.144522) * Ei[8];
 dV += - ((x[0] - -1.992) / (double)0.016058) * Ei[9];
 dV += - ((x[0] - 2.04) / (double)0.178422) * Ei[10];
 dV += - ((x[0] - 0.0240002) / (double)0.0642318) * Ei[11];
 dV += - ((x[0] - 0.168) / (double)0.0361304) * Ei[12];
 dV += - ((x[0] - -2.64) / (double)0.0250906) * Ei[13];
 dV += - ((x[0] - 2.04) / (double)0.178422) * Ei[14];
 dV += - ((x[0] - -1.4736) / (double)0.0102771) * Ei[15];
 dV += - ((x[0] - -1.992) / (double)0.016058) * Ei[16];
 dV += - ((x[0] - 1.8) / (double)0.278784) * Ei[17];
 dV += - ((x[0] - 2.04) / (double)0.178422) * Ei[18];
 dV += - ((x[0] - 0.888) / (double)0.00713687) * Ei[19];
 dV += - ((x[0] - -1.704) / (double)0.0642318) * Ei[20];
 dV += - ((x[0] - -0.69024) / (double)0.0591961) * Ei[21];
 dV += - ((x[0] - 0.7344) / (double)0.000285475) * Ei[22];
 dV += - ((x[0] - -1.4736) / (double)0.0102771) * Ei[23];
 dV += - ((x[0] - -0.912) / (double)0.0812934) * Ei[24];
 dV += - ((x[0] - 0.9264) / (double)0.0045676) * Ei[25];
 dV += - ((x[0] - 2.04) / (double)0.178422) * Ei[26];
 dV += - ((x[0] - -0.264) / (double)0.144522) * Ei[27];
 dV += - ((x[0] - -0.3216) / (double)0.164434) * Ei[28];
 dV += - ((x[0] - 0.23136) / (double)0.0263094) * Ei[29];
 ...
 dU = 0.0;
 dU += (-0.69038 - (x[0] - -2.64) / (double)0.0250906 * Li[0]) * Ei[0];
 dU += (0.553387 - (x[0] - 1.8) / (double)0.278784 * Li[1]) * Ei[1];
 dU += (-0.921427 - (x[0] - -2.28) / (double)0.100362 * Li[2]) * Ei[2];
 dU += (0.546941 - (x[0] - 0.84) / (double)0.0111514 * Li[3]) * Ei[3];
 dU += (-0.964738 - (x[0] - -2.64) / (double)0.0250906 * Li[4]) * Ei[4];
 dU += (-0.774302 - (x[0] - -2.64) / (double)0.0250906 * Li[5]) * Ei[5];
 dU += (-0.0454748 - (x[0] - 0.648) / (double)0.000446055 * Li[6]) * Ei[6];
 dU += (-0.482947 - (x[0] - -0.912) / (double)0.0812934 * Li[7]) * Ei[7];
 dU += (-0.877798 - (x[0] - -1.416) / (double)0.144522 * Li[8]) * Ei[8];
 dU += (-0.684149 - (x[0] - -1.992) / (double)0.016058 * Li[9]) * Ei[9];
 dU += (0.710476 - (x[0] - 2.04) / (double)0.178422 * Li[10]) * Ei[10];
 dU += (0.0617728 - (x[0] - 0.0240002) / (double)0.0642318 * Li[11]) * Ei[11];
 dU += (0.262044 - (x[0] - 0.168) / (double)0.0361304 * Li[12]) * Ei[12];
 dU += (-0.774231 - (x[0] - -2.64) / (double)0.0250906 * Li[13]) * Ei[13];
 dU += (0.880671 - (x[0] - 2.04) / (double)0.178422 * Li[14]) * Ei[14];
 dU += (-0.562695 - (x[0] - -1.4736) / (double)0.0102771 * Li[15]) * Ei[15];
 dU += (-0.673465 - (x[0] - -1.992) / (double)0.016058 * Li[16]) * Ei[16];
 dU += (0.566438 - (x[0] - 1.8) / (double)0.278784 * Li[17]) * Ei[17];
 dU += (0.98981 - (x[0] - 2.04) / (double)0.178422 * Li[18]) * Ei[18];
 dU += (0.40846 - (x[0] - 0.888) / (double)0.00713687 * Li[19]) * Ei[19];
 dU += (-0.518567 - (x[0] - -1.704) / (double)0.0642318 * Li[20]) * Ei[20];
 dU += (-0.306911 - (x[0] - -0.69024) / (double)0.0591961 * Li[21]) * Ei[21];
 dU += (1.44507 - (x[0] - 0.7344) / (double)0.000285475 * Li[22]) * Ei[22];
 dU += (-0.564968 - (x[0] - -1.4736) / (double)0.0102771 * Li[23]) * Ei[23];
 dU += (-0.784627 - (x[0] - -0.912) / (double)0.0812934 * Li[24]) * Ei[24];
 dU += (0.777714 - (x[0] - 0.9264) / (double)0.0045676 * Li[25]) * Ei[25];
 dU += (0.834163 - (x[0] - 2.04) / (double)0.178422 * Li[26]) * Ei[26];
 dU += (-0.093775 - (x[0] - -0.264) / (double)0.144522 * Li[27]) * Ei[27];
 dU += (-0.136163 - (x[0] - -0.3216) / (double)0.164434 * Li[28]) * Ei[28];
 dU += (0.113578 - (x[0] - 0.23136) / (double)0.0263094 * Li[29]) * Ei[29];
  Ei.clear();
  Li.clear();
