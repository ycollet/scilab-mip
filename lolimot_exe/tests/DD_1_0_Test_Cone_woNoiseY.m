function res = DD_1_0_Test_Cone_woNoiseY(x)
Ei = zeros(1, 30);
Li = zeros(1,30);
 U = 0.0;
 V = 0.0;
...
%% Measure - [0.042855 4.24264]
 ...
 dV2 = 0.0;
 dV2 = dV2 - ((x(1) - -2.64) / 0.0250906) * Ei(1);
 dV2 = dV2 - ((x(1) - 1.8) / 0.278784) * Ei(2);
 dV2 = dV2 - ((x(1) - -2.28) / 0.100362) * Ei(3);
 dV2 = dV2 - ((x(1) - 0.84) / 0.0111514) * Ei(4);
 dV2 = dV2 - ((x(1) - -2.64) / 0.0250906) * Ei(5);
 dV2 = dV2 - ((x(1) - -2.64) / 0.0250906) * Ei(6);
 dV2 = dV2 - ((x(1) - 0.648) / 0.000446055) * Ei(7);
 dV2 = dV2 - ((x(1) - -0.912) / 0.0812934) * Ei(8);
 dV2 = dV2 - ((x(1) - -1.416) / 0.144522) * Ei(9);
 dV2 = dV2 - ((x(1) - -1.992) / 0.016058) * Ei(10);
 dV2 = dV2 - ((x(1) - 2.04) / 0.178422) * Ei(11);
 dV2 = dV2 - ((x(1) - 0.0240002) / 0.0642318) * Ei(12);
 dV2 = dV2 - ((x(1) - 0.168) / 0.0361304) * Ei(13);
 dV2 = dV2 - ((x(1) - -2.64) / 0.0250906) * Ei(14);
 dV2 = dV2 - ((x(1) - 2.04) / 0.178422) * Ei(15);
 dV2 = dV2 - ((x(1) - -1.4736) / 0.0102771) * Ei(16);
 dV2 = dV2 - ((x(1) - -1.992) / 0.016058) * Ei(17);
 dV2 = dV2 - ((x(1) - 1.8) / 0.278784) * Ei(18);
 dV2 = dV2 - ((x(1) - 2.04) / 0.178422) * Ei(19);
 dV2 = dV2 - ((x(1) - 0.888) / 0.00713687) * Ei(20);
 dV2 = dV2 - ((x(1) - -1.704) / 0.0642318) * Ei(21);
 dV2 = dV2 - ((x(1) - -0.69024) / 0.0591961) * Ei(22);
 dV2 = dV2 - ((x(1) - 0.7344) / 0.000285475) * Ei(23);
 dV2 = dV2 - ((x(1) - -1.4736) / 0.0102771) * Ei(24);
 dV2 = dV2 - ((x(1) - -0.912) / 0.0812934) * Ei(25);
 dV2 = dV2 - ((x(1) - 0.9264) / 0.0045676) * Ei(26);
 dV2 = dV2 - ((x(1) - 2.04) / 0.178422) * Ei(27);
 dV2 = dV2 - ((x(1) - -0.264) / 0.144522) * Ei(28);
 dV2 = dV2 - ((x(1) - -0.3216) / 0.164434) * Ei(29);
 dV2 = dV2 - ((x(1) - 0.23136) / 0.0263094) * Ei(30);
 ...
 dU2 = 0.0;
 dU2 = dU2 + (-0.69038 - ((x(1) - -2.64) / 0.0250906) * Li(1)) * Ei(1);
 dU2 = dU2 + (0.553387 - ((x(1) - 1.8) / 0.278784) * Li(2)) * Ei(2);
 dU2 = dU2 + (-0.921427 - ((x(1) - -2.28) / 0.100362) * Li(3)) * Ei(3);
 dU2 = dU2 + (0.546941 - ((x(1) - 0.84) / 0.0111514) * Li(4)) * Ei(4);
 dU2 = dU2 + (-0.964738 - ((x(1) - -2.64) / 0.0250906) * Li(5)) * Ei(5);
 dU2 = dU2 + (-0.774302 - ((x(1) - -2.64) / 0.0250906) * Li(6)) * Ei(6);
 dU2 = dU2 + (-0.0454748 - ((x(1) - 0.648) / 0.000446055) * Li(7)) * Ei(7);
 dU2 = dU2 + (-0.482947 - ((x(1) - -0.912) / 0.0812934) * Li(8)) * Ei(8);
 dU2 = dU2 + (-0.877798 - ((x(1) - -1.416) / 0.144522) * Li(9)) * Ei(9);
 dU2 = dU2 + (-0.684149 - ((x(1) - -1.992) / 0.016058) * Li(10)) * Ei(10);
 dU2 = dU2 + (0.710476 - ((x(1) - 2.04) / 0.178422) * Li(11)) * Ei(11);
 dU2 = dU2 + (0.0617728 - ((x(1) - 0.0240002) / 0.0642318) * Li(12)) * Ei(12);
 dU2 = dU2 + (0.262044 - ((x(1) - 0.168) / 0.0361304) * Li(13)) * Ei(13);
 dU2 = dU2 + (-0.774231 - ((x(1) - -2.64) / 0.0250906) * Li(14)) * Ei(14);
 dU2 = dU2 + (0.880671 - ((x(1) - 2.04) / 0.178422) * Li(15)) * Ei(15);
 dU2 = dU2 + (-0.562695 - ((x(1) - -1.4736) / 0.0102771) * Li(16)) * Ei(16);
 dU2 = dU2 + (-0.673465 - ((x(1) - -1.992) / 0.016058) * Li(17)) * Ei(17);
 dU2 = dU2 + (0.566438 - ((x(1) - 1.8) / 0.278784) * Li(18)) * Ei(18);
 dU2 = dU2 + (0.98981 - ((x(1) - 2.04) / 0.178422) * Li(19)) * Ei(19);
 dU2 = dU2 + (0.40846 - ((x(1) - 0.888) / 0.00713687) * Li(20)) * Ei(20);
 dU2 = dU2 + (-0.518567 - ((x(1) - -1.704) / 0.0642318) * Li(21)) * Ei(21);
 dU2 = dU2 + (-0.306911 - ((x(1) - -0.69024) / 0.0591961) * Li(22)) * Ei(22);
 dU2 = dU2 + (1.44507 - ((x(1) - 0.7344) / 0.000285475) * Li(23)) * Ei(23);
 dU2 = dU2 + (-0.564968 - ((x(1) - -1.4736) / 0.0102771) * Li(24)) * Ei(24);
 dU2 = dU2 + (-0.784627 - ((x(1) - -0.912) / 0.0812934) * Li(25)) * Ei(25);
 dU2 = dU2 + (0.777714 - ((x(1) - 0.9264) / 0.0045676) * Li(26)) * Ei(26);
 dU2 = dU2 + (0.834163 - ((x(1) - 2.04) / 0.178422) * Li(27)) * Ei(27);
 dU2 = dU2 + (-0.093775 - ((x(1) - -0.264) / 0.144522) * Li(28)) * Ei(28);
 dU2 = dU2 + (-0.136163 - ((x(1) - -0.3216) / 0.164434) * Li(29)) * Ei(29);
 dU2 = dU2 + (0.113578 - ((x(1) - 0.23136) / 0.0263094) * Li(30)) * Ei(30);
 ...
 ddV = 0.0;
 ddV = ddV + (((x(1) - -2.64) / 0.0250906) * ((x(2) - -2.76) / 0.0111514)) * Ei(1);
 ddV = ddV + (((x(1) - 1.8) / 0.278784) * ((x(2) - -2.64) / 0.0250906)) * Ei(2);
 ddV = ddV + (((x(1) - -2.28) / 0.100362) * ((x(2) - -0.84) / 0.178422)) * Ei(3);
 ddV = ddV + (((x(1) - 0.84) / 0.0111514) * ((x(2) - 1.32) / 0.100362)) * Ei(4);
 ddV = ddV + (((x(1) - -2.64) / 0.0250906) * ((x(2) - 0.696) / 0.0642318)) * Ei(5);
 ddV = ddV + (((x(1) - -2.64) / 0.0250906) * ((x(2) - 2.136) / 0.144522)) * Ei(6);
 ddV = ddV + (((x(1) - 0.648) / 0.000446055) * ((x(2) - -0.84) / 0.401449)) * Ei(7);
 ddV = ddV + (((x(1) - -0.912) / 0.0812934) * ((x(2) - -1.608) / 0.00713687)) * Ei(8);
 ddV = ddV + (((x(1) - -1.416) / 0.144522) * ((x(2) - 0.696) / 0.0642318)) * Ei(9);
 ddV = ddV + (((x(1) - -1.992) / 0.016058) * ((x(2) - 2.136) / 0.144522)) * Ei(10);
 ddV = ddV + (((x(1) - 2.04) / 0.178422) * ((x(2) - -1.992) / 0.016058)) * Ei(11);
 ddV = ddV + (((x(1) - 0.0240002) / 0.0642318) * ((x(2) - 0.696) / 0.0642318)) * Ei(12);
 ddV = ddV + (((x(1) - 0.168) / 0.0361304) * ((x(2) - -0.84) / 0.178422)) * Ei(13);
 ddV = ddV + (((x(1) - -2.64) / 0.0250906) * ((x(2) - -2.16) / 0.0250906)) * Ei(14);
 ddV = ddV + (((x(1) - 2.04) / 0.178422) * ((x(2) - -1.0128) / 0.0924939)) * Ei(15);
 ddV = ddV + (((x(1) - -1.4736) / 0.0102771) * ((x(2) - 2.136) / 0.144522)) * Ei(16);
 ddV = ddV + (((x(1) - -1.992) / 0.016058) * ((x(2) - -2.16) / 0.0250906)) * Ei(17);
 ddV = ddV + (((x(1) - 1.8) / 0.278784) * ((x(2) - 2.52) / 0.0446054)) * Ei(18);
 ddV = ddV + (((x(1) - 2.04) / 0.178422) * ((x(2) - 0.1392) / 0.0411084)) * Ei(19);
 ddV = ddV + (((x(1) - 0.888) / 0.00713687) * ((x(2) - -1.992) / 0.016058)) * Ei(20);
 ddV = ddV + (((x(1) - -1.704) / 0.0642318) * ((x(2) - -2.76) / 0.0111514)) * Ei(21);
 ddV = ddV + (((x(1) - -0.69024) / 0.0591961) * ((x(2) - 2.136) / 0.144522)) * Ei(22);
 ddV = ddV + (((x(1) - 0.7344) / 0.000285475) * ((x(2) - -0.552) / 0.256927)) * Ei(23);
 ddV = ddV + (((x(1) - -1.4736) / 0.0102771) * ((x(2) - -2.16) / 0.0250906)) * Ei(24);
 ddV = ddV + (((x(1) - -0.912) / 0.0812934) * ((x(2) - -0.648) / 0.11419)) * Ei(25);
 ddV = ddV + (((x(1) - 0.9264) / 0.0045676) * ((x(2) - -0.552) / 0.256927)) * Ei(26);
 ddV = ddV + (((x(1) - 2.04) / 0.178422) * ((x(2) - 1.32) / 0.100362)) * Ei(27);
 ddV = ddV + (((x(1) - -0.264) / 0.144522) * ((x(2) - -2.76) / 0.0111514)) * Ei(28);
 ddV = ddV + (((x(1) - -0.3216) / 0.164434) * ((x(2) - -2.16) / 0.0250906)) * Ei(29);
 ddV = ddV + (((x(1) - 0.23136) / 0.0263094) * ((x(2) - 2.136) / 0.144522)) * Ei(30);
 ...
 ddU = 0.0;
 ddU = ddU - (-0.69038 * ((x(2) - -2.76) / 0.0111514) + (-0.72087 - ((x(2) - -2.76) / 0.0111514) * Li(1)) * ((x(1) - -2.64) / 0.0250906)) * Ei(1);
 ddU = ddU - (0.553387 * ((x(2) - -2.64) / 0.0250906) + (-0.817762 - ((x(2) - -2.64) / 0.0250906) * Li(2)) * ((x(1) - 1.8) / 0.278784)) * Ei(2);
 ddU = ddU - (-0.921427 * ((x(2) - -0.84) / 0.178422) + (-0.331011 - ((x(2) - -0.84) / 0.178422) * Li(3)) * ((x(1) - -2.28) / 0.100362)) * Ei(3);
 ddU = ddU - (0.546941 * ((x(2) - 1.32) / 0.100362) + (0.830828 - ((x(2) - 1.32) / 0.100362) * Li(4)) * ((x(1) - 0.84) / 0.0111514)) * Ei(4);
 ddU = ddU - (-0.964738 * ((x(2) - 0.696) / 0.0642318) + (0.245693 - ((x(2) - 0.696) / 0.0642318) * Li(5)) * ((x(1) - -2.64) / 0.0250906)) * Ei(5);
 ddU = ddU - (-0.774302 * ((x(2) - 2.136) / 0.144522) + (0.62503 - ((x(2) - 2.136) / 0.144522) * Li(6)) * ((x(1) - -2.64) / 0.0250906)) * Ei(6);
 ddU = ddU - (-0.0454748 * ((x(2) - -0.84) / 0.401449) + (-0.624699 - ((x(2) - -0.84) / 0.401449) * Li(7)) * ((x(1) - 0.648) / 0.000446055)) * Ei(7);
 ddU = ddU - (-0.482947 * ((x(2) - -1.608) / 0.00713687) + (-0.843472 - ((x(2) - -1.608) / 0.00713687) * Li(8)) * ((x(1) - -0.912) / 0.0812934)) * Ei(8);
 ddU = ddU - (-0.877798 * ((x(2) - 0.696) / 0.0642318) + (0.440825 - ((x(2) - 0.696) / 0.0642318) * Li(9)) * ((x(1) - -1.416) / 0.144522)) * Ei(9);
 ddU = ddU - (-0.684149 * ((x(2) - 2.136) / 0.144522) + (0.723978 - ((x(2) - 2.136) / 0.144522) * Li(10)) * ((x(1) - -1.992) / 0.016058)) * Ei(10);
 ddU = ddU - (0.710476 * ((x(2) - -1.992) / 0.016058) + (-0.687386 - ((x(2) - -1.992) / 0.016058) * Li(11)) * ((x(1) - 2.04) / 0.178422)) * Ei(11);
 ddU = ddU - (0.0617728 * ((x(2) - 0.696) / 0.0642318) + (0.887686 - ((x(2) - 0.696) / 0.0642318) * Li(12)) * ((x(1) - 0.0240002) / 0.0642318)) * Ei(12);
 ddU = ddU - (0.262044 * ((x(2) - -0.84) / 0.178422) + (-0.888176 - ((x(2) - -0.84) / 0.178422) * Li(13)) * ((x(1) - 0.168) / 0.0361304)) * Ei(13);
 ddU = ddU - (-0.774231 * ((x(2) - -2.16) / 0.0250906) + (-0.625282 - ((x(2) - -2.16) / 0.0250906) * Li(14)) * ((x(1) - -2.64) / 0.0250906)) * Ei(14);
 ddU = ddU - (0.880671 * ((x(2) - -1.0128) / 0.0924939) + (-0.450174 - ((x(2) - -1.0128) / 0.0924939) * Li(15)) * ((x(1) - 2.04) / 0.178422)) * Ei(15);
 ddU = ddU - (-0.562695 * ((x(2) - 2.136) / 0.144522) + (0.820673 - ((x(2) - 2.136) / 0.144522) * Li(16)) * ((x(1) - -1.4736) / 0.0102771)) * Ei(16);
 ddU = ddU - (-0.673465 * ((x(2) - -2.16) / 0.0250906) + (-0.736364 - ((x(2) - -2.16) / 0.0250906) * Li(17)) * ((x(1) - -1.992) / 0.016058)) * Ei(17);
 ddU = ddU - (0.566438 * ((x(2) - 2.52) / 0.0446054) + (0.819294 - ((x(2) - 2.52) / 0.0446054) * Li(18)) * ((x(1) - 1.8) / 0.278784)) * Ei(18);
 ddU = ddU - (0.98981 * ((x(2) - 0.1392) / 0.0411084) + (0.0719228 - ((x(2) - 0.1392) / 0.0411084) * Li(19)) * ((x(1) - 2.04) / 0.178422)) * Ei(19);
 ddU = ddU - (0.40846 * ((x(2) - -1.992) / 0.016058) + (-0.912237 - ((x(2) - -1.992) / 0.016058) * Li(20)) * ((x(1) - 0.888) / 0.00713687)) * Ei(20);
 ddU = ddU - (-0.518567 * ((x(2) - -2.76) / 0.0111514) + (-0.85395 - ((x(2) - -2.76) / 0.0111514) * Li(21)) * ((x(1) - -1.704) / 0.0642318)) * Ei(21);
 ddU = ddU - (-0.306911 * ((x(2) - 2.136) / 0.144522) + (0.945357 - ((x(2) - 2.136) / 0.144522) * Li(22)) * ((x(1) - -0.69024) / 0.0591961)) * Ei(22);
 ddU = ddU - (1.44507 * ((x(2) - -0.552) / 0.256927) + (-0.500821 - ((x(2) - -0.552) / 0.256927) * Li(23)) * ((x(1) - 0.7344) / 0.000285475)) * Ei(23);
 ddU = ddU - (-0.564968 * ((x(2) - -2.16) / 0.0250906) + (-0.822611 - ((x(2) - -2.16) / 0.0250906) * Li(24)) * ((x(1) - -1.4736) / 0.0102771)) * Ei(24);
 ddU = ddU - (-0.784627 * ((x(2) - -0.648) / 0.11419) + (-0.552661 - ((x(2) - -0.648) / 0.11419) * Li(25)) * ((x(1) - -0.912) / 0.0812934)) * Ei(25);
 ddU = ddU - (0.777714 * ((x(2) - -0.552) / 0.256927) + (-0.433307 - ((x(2) - -0.552) / 0.256927) * Li(26)) * ((x(1) - 0.9264) / 0.0045676)) * Ei(26);
 ddU = ddU - (0.834163 * ((x(2) - 1.32) / 0.100362) + (0.536205 - ((x(2) - 1.32) / 0.100362) * Li(27)) * ((x(1) - 2.04) / 0.178422)) * Ei(27);
 ddU = ddU - (-0.093775 * ((x(2) - -2.76) / 0.0111514) + (-0.995116 - ((x(2) - -2.76) / 0.0111514) * Li(28)) * ((x(1) - -0.264) / 0.144522)) * Ei(28);
 ddU = ddU - (-0.136163 * ((x(2) - -2.16) / 0.0250906) + (-0.97762 - ((x(2) - -2.16) / 0.0250906) * Li(29)) * ((x(1) - -0.3216) / 0.164434)) * Ei(29);
 ddU = ddU - (0.113578 * ((x(2) - 2.136) / 0.144522) + (0.989991 - ((x(2) - 2.136) / 0.144522) * Li(30)) * ((x(1) - 0.23136) / 0.0263094)) * Ei(30);
  clear Ei;
  clear Li;
