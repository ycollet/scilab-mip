function res = D_0_Test_Cone_woNoiseY(x)
Ei = zeros(1, 30);
Li = zeros(1,30);
 U = 0.0;
 V = 0.0;
...
%% Measure - [0.042855 4.24264]
 ...
 dV = 0.0;
 dV = dV - ((x(1) - -2.64) / 0.0250906) * Ei(1);
 dV = dV - ((x(1) - 1.8) / 0.278784) * Ei(2);
 dV = dV - ((x(1) - -2.28) / 0.100362) * Ei(3);
 dV = dV - ((x(1) - 0.84) / 0.0111514) * Ei(4);
 dV = dV - ((x(1) - -2.64) / 0.0250906) * Ei(5);
 dV = dV - ((x(1) - -2.64) / 0.0250906) * Ei(6);
 dV = dV - ((x(1) - 0.648) / 0.000446055) * Ei(7);
 dV = dV - ((x(1) - -0.912) / 0.0812934) * Ei(8);
 dV = dV - ((x(1) - -1.416) / 0.144522) * Ei(9);
 dV = dV - ((x(1) - -1.992) / 0.016058) * Ei(10);
 dV = dV - ((x(1) - 2.04) / 0.178422) * Ei(11);
 dV = dV - ((x(1) - 0.0240002) / 0.0642318) * Ei(12);
 dV = dV - ((x(1) - 0.168) / 0.0361304) * Ei(13);
 dV = dV - ((x(1) - -2.64) / 0.0250906) * Ei(14);
 dV = dV - ((x(1) - 2.04) / 0.178422) * Ei(15);
 dV = dV - ((x(1) - -1.4736) / 0.0102771) * Ei(16);
 dV = dV - ((x(1) - -1.992) / 0.016058) * Ei(17);
 dV = dV - ((x(1) - 1.8) / 0.278784) * Ei(18);
 dV = dV - ((x(1) - 2.04) / 0.178422) * Ei(19);
 dV = dV - ((x(1) - 0.888) / 0.00713687) * Ei(20);
 dV = dV - ((x(1) - -1.704) / 0.0642318) * Ei(21);
 dV = dV - ((x(1) - -0.69024) / 0.0591961) * Ei(22);
 dV = dV - ((x(1) - 0.7344) / 0.000285475) * Ei(23);
 dV = dV - ((x(1) - -1.4736) / 0.0102771) * Ei(24);
 dV = dV - ((x(1) - -0.912) / 0.0812934) * Ei(25);
 dV = dV - ((x(1) - 0.9264) / 0.0045676) * Ei(26);
 dV = dV - ((x(1) - 2.04) / 0.178422) * Ei(27);
 dV = dV - ((x(1) - -0.264) / 0.144522) * Ei(28);
 dV = dV - ((x(1) - -0.3216) / 0.164434) * Ei(29);
 dV = dV - ((x(1) - 0.23136) / 0.0263094) * Ei(30);
 ...
 dU = 0.0;
 dU = dU + (-0.69038 - ((x(1) - -2.64) / 0.0250906) * Li(1)) * Ei(1);
 dU = dU + (0.553387 - ((x(1) - 1.8) / 0.278784) * Li(2)) * Ei(2);
 dU = dU + (-0.921427 - ((x(1) - -2.28) / 0.100362) * Li(3)) * Ei(3);
 dU = dU + (0.546941 - ((x(1) - 0.84) / 0.0111514) * Li(4)) * Ei(4);
 dU = dU + (-0.964738 - ((x(1) - -2.64) / 0.0250906) * Li(5)) * Ei(5);
 dU = dU + (-0.774302 - ((x(1) - -2.64) / 0.0250906) * Li(6)) * Ei(6);
 dU = dU + (-0.0454748 - ((x(1) - 0.648) / 0.000446055) * Li(7)) * Ei(7);
 dU = dU + (-0.482947 - ((x(1) - -0.912) / 0.0812934) * Li(8)) * Ei(8);
 dU = dU + (-0.877798 - ((x(1) - -1.416) / 0.144522) * Li(9)) * Ei(9);
 dU = dU + (-0.684149 - ((x(1) - -1.992) / 0.016058) * Li(10)) * Ei(10);
 dU = dU + (0.710476 - ((x(1) - 2.04) / 0.178422) * Li(11)) * Ei(11);
 dU = dU + (0.0617728 - ((x(1) - 0.0240002) / 0.0642318) * Li(12)) * Ei(12);
 dU = dU + (0.262044 - ((x(1) - 0.168) / 0.0361304) * Li(13)) * Ei(13);
 dU = dU + (-0.774231 - ((x(1) - -2.64) / 0.0250906) * Li(14)) * Ei(14);
 dU = dU + (0.880671 - ((x(1) - 2.04) / 0.178422) * Li(15)) * Ei(15);
 dU = dU + (-0.562695 - ((x(1) - -1.4736) / 0.0102771) * Li(16)) * Ei(16);
 dU = dU + (-0.673465 - ((x(1) - -1.992) / 0.016058) * Li(17)) * Ei(17);
 dU = dU + (0.566438 - ((x(1) - 1.8) / 0.278784) * Li(18)) * Ei(18);
 dU = dU + (0.98981 - ((x(1) - 2.04) / 0.178422) * Li(19)) * Ei(19);
 dU = dU + (0.40846 - ((x(1) - 0.888) / 0.00713687) * Li(20)) * Ei(20);
 dU = dU + (-0.518567 - ((x(1) - -1.704) / 0.0642318) * Li(21)) * Ei(21);
 dU = dU + (-0.306911 - ((x(1) - -0.69024) / 0.0591961) * Li(22)) * Ei(22);
 dU = dU + (1.44507 - ((x(1) - 0.7344) / 0.000285475) * Li(23)) * Ei(23);
 dU = dU + (-0.564968 - ((x(1) - -1.4736) / 0.0102771) * Li(24)) * Ei(24);
 dU = dU + (-0.784627 - ((x(1) - -0.912) / 0.0812934) * Li(25)) * Ei(25);
 dU = dU + (0.777714 - ((x(1) - 0.9264) / 0.0045676) * Li(26)) * Ei(26);
 dU = dU + (0.834163 - ((x(1) - 2.04) / 0.178422) * Li(27)) * Ei(27);
 dU = dU + (-0.093775 - ((x(1) - -0.264) / 0.144522) * Li(28)) * Ei(28);
 dU = dU + (-0.136163 - ((x(1) - -0.3216) / 0.164434) * Li(29)) * Ei(29);
 dU = dU + (0.113578 - ((x(1) - 0.23136) / 0.0263094) * Li(30)) * Ei(30);
  clear Ei;
  clear Li;
    res = ((dU*V-dV*U)/(V*V));
