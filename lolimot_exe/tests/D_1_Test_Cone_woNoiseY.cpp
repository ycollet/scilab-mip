...
using namespace std;
extern "C" double D_1_Test_Cone_woNoiseY(vector<double> & x)
{
double Result;
vector<double> Ei(30);
vector<double> Li(30);
...
// Measure - [0.042855 4.24264]
 ...
 dV = 0.0;
 dV += - ((x[1] - -2.76) / (double)0.0111514) * Ei[0];
 dV += - ((x[1] - -2.64) / (double)0.0250906) * Ei[1];
 dV += - ((x[1] - -0.84) / (double)0.178422) * Ei[2];
 dV += - ((x[1] - 1.32) / (double)0.100362) * Ei[3];
 dV += - ((x[1] - 0.696) / (double)0.0642318) * Ei[4];
 dV += - ((x[1] - 2.136) / (double)0.144522) * Ei[5];
 dV += - ((x[1] - -0.84) / (double)0.401449) * Ei[6];
 dV += - ((x[1] - -1.608) / (double)0.00713687) * Ei[7];
 dV += - ((x[1] - 0.696) / (double)0.0642318) * Ei[8];
 dV += - ((x[1] - 2.136) / (double)0.144522) * Ei[9];
 dV += - ((x[1] - -1.992) / (double)0.016058) * Ei[10];
 dV += - ((x[1] - 0.696) / (double)0.0642318) * Ei[11];
 dV += - ((x[1] - -0.84) / (double)0.178422) * Ei[12];
 dV += - ((x[1] - -2.16) / (double)0.0250906) * Ei[13];
 dV += - ((x[1] - -1.0128) / (double)0.0924939) * Ei[14];
 dV += - ((x[1] - 2.136) / (double)0.144522) * Ei[15];
 dV += - ((x[1] - -2.16) / (double)0.0250906) * Ei[16];
 dV += - ((x[1] - 2.52) / (double)0.0446054) * Ei[17];
 dV += - ((x[1] - 0.1392) / (double)0.0411084) * Ei[18];
 dV += - ((x[1] - -1.992) / (double)0.016058) * Ei[19];
 dV += - ((x[1] - -2.76) / (double)0.0111514) * Ei[20];
 dV += - ((x[1] - 2.136) / (double)0.144522) * Ei[21];
 dV += - ((x[1] - -0.552) / (double)0.256927) * Ei[22];
 dV += - ((x[1] - -2.16) / (double)0.0250906) * Ei[23];
 dV += - ((x[1] - -0.648) / (double)0.11419) * Ei[24];
 dV += - ((x[1] - -0.552) / (double)0.256927) * Ei[25];
 dV += - ((x[1] - 1.32) / (double)0.100362) * Ei[26];
 dV += - ((x[1] - -2.76) / (double)0.0111514) * Ei[27];
 dV += - ((x[1] - -2.16) / (double)0.0250906) * Ei[28];
 dV += - ((x[1] - 2.136) / (double)0.144522) * Ei[29];
 ...
 dU = 0.0;
 dU += (-0.72087 - (x[1] - -2.76) / (double)0.0111514 * Li[0]) * Ei[0];
 dU += (-0.817762 - (x[1] - -2.64) / (double)0.0250906 * Li[1]) * Ei[1];
 dU += (-0.331011 - (x[1] - -0.84) / (double)0.178422 * Li[2]) * Ei[2];
 dU += (0.830828 - (x[1] - 1.32) / (double)0.100362 * Li[3]) * Ei[3];
 dU += (0.245693 - (x[1] - 0.696) / (double)0.0642318 * Li[4]) * Ei[4];
 dU += (0.62503 - (x[1] - 2.136) / (double)0.144522 * Li[5]) * Ei[5];
 dU += (-0.624699 - (x[1] - -0.84) / (double)0.401449 * Li[6]) * Ei[6];
 dU += (-0.843472 - (x[1] - -1.608) / (double)0.00713687 * Li[7]) * Ei[7];
 dU += (0.440825 - (x[1] - 0.696) / (double)0.0642318 * Li[8]) * Ei[8];
 dU += (0.723978 - (x[1] - 2.136) / (double)0.144522 * Li[9]) * Ei[9];
 dU += (-0.687386 - (x[1] - -1.992) / (double)0.016058 * Li[10]) * Ei[10];
 dU += (0.887686 - (x[1] - 0.696) / (double)0.0642318 * Li[11]) * Ei[11];
 dU += (-0.888176 - (x[1] - -0.84) / (double)0.178422 * Li[12]) * Ei[12];
 dU += (-0.625282 - (x[1] - -2.16) / (double)0.0250906 * Li[13]) * Ei[13];
 dU += (-0.450174 - (x[1] - -1.0128) / (double)0.0924939 * Li[14]) * Ei[14];
 dU += (0.820673 - (x[1] - 2.136) / (double)0.144522 * Li[15]) * Ei[15];
 dU += (-0.736364 - (x[1] - -2.16) / (double)0.0250906 * Li[16]) * Ei[16];
 dU += (0.819294 - (x[1] - 2.52) / (double)0.0446054 * Li[17]) * Ei[17];
 dU += (0.0719228 - (x[1] - 0.1392) / (double)0.0411084 * Li[18]) * Ei[18];
 dU += (-0.912237 - (x[1] - -1.992) / (double)0.016058 * Li[19]) * Ei[19];
 dU += (-0.85395 - (x[1] - -2.76) / (double)0.0111514 * Li[20]) * Ei[20];
 dU += (0.945357 - (x[1] - 2.136) / (double)0.144522 * Li[21]) * Ei[21];
 dU += (-0.500821 - (x[1] - -0.552) / (double)0.256927 * Li[22]) * Ei[22];
 dU += (-0.822611 - (x[1] - -2.16) / (double)0.0250906 * Li[23]) * Ei[23];
 dU += (-0.552661 - (x[1] - -0.648) / (double)0.11419 * Li[24]) * Ei[24];
 dU += (-0.433307 - (x[1] - -0.552) / (double)0.256927 * Li[25]) * Ei[25];
 dU += (0.536205 - (x[1] - 1.32) / (double)0.100362 * Li[26]) * Ei[26];
 dU += (-0.995116 - (x[1] - -2.76) / (double)0.0111514 * Li[27]) * Ei[27];
 dU += (-0.97762 - (x[1] - -2.16) / (double)0.0250906 * Li[28]) * Ei[28];
 dU += (0.989991 - (x[1] - 2.136) / (double)0.144522 * Li[29]) * Ei[29];
  Ei.clear();
  Li.clear();
