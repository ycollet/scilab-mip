...
void export_Destroy_Data_Cpp(LL_Lolimot * Lolimot, ofstream & F_Lolimot, const string & VarType)
{
...
bool exportHeaderInCpp2(LL_Lolimot * Lolimot, const string & path,
...
bool exportHeaderInCpp(LL_Lolimot * Lolimot, const string & path,
		       const string & nameFunction, const vector<Model_Input> & ListInput)
{
  ofstream       F_Lolimot;
  string         strTmp;
...
bool exportFunctionInCpp(LL_Lolimot * Lolimot, const string & path, const string & nameFunction, 
...
bool exportDerivativeFunctionInCpp(LL_Lolimot * Lolimot, const string & path, const string & nameFunction, 
...
bool exportDerivativeFunctionInCpp2(LL_Lolimot * Lolimot, const string & path, const string & nameFunction,
				    const vector<Model_Input> & ListInput)
{
...
bool exportSecondDerivativeFunctionInCpp(LL_Lolimot * Lolimot, const string & path, const string & nameFunction,
...
bool exportSecondDerivativeFunctionInCpp2(LL_Lolimot * Lolimot, const string & path, const string & nameFunction,
					  const vector<Model_Input> & ListInput)
{
  unsigned int   noPartition, nbPartition = Lolimot->getPartitionSet().size();
  LL_Partition * curPartition = NULL;
