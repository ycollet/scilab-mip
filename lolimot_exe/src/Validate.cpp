...
void Validate(LL_Lolimot * Lolimot, vector<vector<float> > & InputData, vector<vector<float> > & MeasureData,
	      ...
	      unsigned int Measure, string ResultDir, string ModelName, vector<vector<float> > & TempoInput,
	      ...
	      unsigned int NumOfValidateFile, bool Compute_C1, bool Compute_C2)
{
  ...
  if (!Validation)
	...
	{
	  FileName << ResultDir << ModelName << "_Data_FB_Meas_" << SequenceName;
	  FileName << "_" << List_Model_Output[Measure].Name << ".dat";
	} /* End If */
      else
	{
	  FileName << ResultDir << ModelName << "_Data_" << SequenceName;
	  FileName << "_" << List_Model_Output[Measure].Name << ".dat";
	} /* End Else */
    } /* End If */
  else
    {
      if (List_Retro_Input.size()!=0)
	{
	  FileName << ResultDir << ModelName << "_Data_FB_Meas_" << SequenceName << "_" << NumOfValidateFile;
	  FileName << "_" << List_Model_Output[Measure].Name << ".dat";
	} /* End If */
      else
	{
	  FileName << ResultDir << ModelName << "_Data_" << SequenceName << "_" << NumOfValidateFile;
	  FileName << "_" << List_Model_Output[Measure].Name << ".dat";
	} /* End Else */
    } /* End Else */
  ...
  if (!Validation)
    {
      if (List_Retro_Input.size()!=0)
	{
	  FileName << ResultDir << ModelName << "_Data_FB_Meas_Sumup_" << SequenceName;
	  FileName << "_" << List_Model_Output[Measure].Name << ".dat";
	} /* End If */
      else
	{
	  FileName << ResultDir << ModelName << "_Data_Sumup_" << SequenceName;
	  FileName << "_" << List_Model_Output[Measure].Name << ".dat";	      
	} /* End Else */
    } /* End If */
  else
    {
      if (List_Retro_Input.size()!=0)
	{
	  FileName << ResultDir << ModelName << "_Data_FB_Meas_Sumup_" << SequenceName << "_" << NumOfValidateFile;
	  FileName << "_" << List_Model_Output[Measure].Name << ".dat";
	} /* End If */
      else
	{
	  FileName << ResultDir << ModelName << "_Data_Sumup_" << SequenceName << "_" << NumOfValidateFile;
	  FileName << "_" << List_Model_Output[Measure].Name << ".dat";
	} /* End Else */
    } /* End Else */
  ...
  if (List_Retro_Input.size()!=0)
    {
      ...
      if (!Validation)
	{
	  FileName << ResultDir << ModelName << "_Data_FB_Estim_" << SequenceName;
	  FileName << "_" << List_Model_Output[Measure].Name << ".dat";
	} /* End If */
      else
	{
	  FileName << ResultDir << ModelName << "_Data_FB_Estim_" << SequenceName << "_" << NumOfValidateFile;
	  FileName << "_" << List_Model_Output[Measure].Name << ".dat";
	} /* End Else */
      ...
      for(unsigned int i=0; i<InputData.size(); i++)
	{
      ...
      if (!Validation)
	{
	  FileName << ResultDir << ModelName << "_Data_FB_Estim_Sumup_" << SequenceName;
	  FileName << "_" << List_Model_Output[Measure].Name << ".dat";
	} /* End If */
      else
	{
	  FileName << ResultDir << ModelName << "_Data_FB_Estim_Sumup_" << SequenceName << "_" << NumOfValidateFile;
	  FileName << "_" << List_Model_Output[Measure].Name << ".dat";
	} /* End Else */
