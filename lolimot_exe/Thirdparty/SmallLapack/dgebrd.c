...
#define a_ref(a_1,a_2) a[(a_2)*a_dim1 + a_1]
  ...
  *info = 0;
  ...
  if (nb > 1 && nb < minmn) 
    {
      /* Set the crossover point NX. Computing MAX */
  ...
  for (i__ = 1; i__2 < 0 ? i__ >= i__1 : i__ <= i__1; i__ += i__2) 
    {
      ...
      i__3 = *m - i__ - nb + 1;
      i__4 = *n - i__ - nb + 1;
      dgemm_("No transpose", "Transpose", &i__3, &i__4, &nb, &c_b21, &a_ref(i__ + nb, i__),
	     lda, &work[ldwrkx * nb + nb + 1], &ldwrky, &c_b22, &a_ref(i__ + nb, i__ + nb), lda);
      i__3 = *m - i__ - nb + 1;
      i__4 = *n - i__ - nb + 1;
  ...
  i__2 = *m - i__ + 1;
  i__1 = *n - i__ + 1;
  dgebd2_(&i__2, &i__1, &a_ref(i__, i__), lda, &d__[i__], &e[i__], &tauq[i__], &taup[i__], &work[1], &iinfo);
  work[1] = ws;
  return 0;
