...
c  in the space occupied by a(.).
      ...
      subroutine ds_saipy(s,a,la,i,y,n)
      implicit double precision (a-h,r-z), integer (i-q)
      dimension a(la,0:*),y(*)
c  saxpy with column i of A
      call ds_mysaxpy(s,a(1,i),y,n)
      return
      end

      subroutine ds_isaipy(s,a,la,i,y,n,lr,li)
      implicit double precision (a-h,r-z), integer (i-q)
      dimension a(la,0:*),y(*),lr(*),li(*)
c  indirectly addressed saxpy with column i of A
      call ds_isaxpy(s,a(1,i),lr,y,n)
      return
      end

      subroutine ds_isaipy1(s,a,la,i,y,n,lr,li,m1)
      implicit double precision (a-h,r-z), integer (i-q)
      dimension a(la,0:*),y(*),lr(*),li(*)
c  indirectly addressed saxpy with column i of A_1
      call ds_isaxpy(s,a(1,i),lr,y,m1)
      return
      end

c     subroutine ds_isaipy2(s,a,la,i,y,n,lr,li,m1)
...
c     call ds_isaxpy(s,a(1,i),lr(m1+1),y(m1+1),n-m1)
c     return
c     end

c     subroutine ds_ssaipy(s,a,la,i,y,n)
c     implicit double precision (a-h,r-z), integer (i-q)
c     dimension a(la,0:*),y(*)
c  ssaxpy with column i of A
c     call ds_ssaxpy(s,a(1,i),y,n)
c     return
c     end

c     subroutine fsd_ssaxpy(a,x,y,n)
c     implicit double precision (a-h,r-z), integer (i-q)
c     dimension x(*),y(*)
...
c     end
      ...
      function ds_aiscpr(n,a,la,i,x,b)
      implicit double precision (a-h,r-z), integer (i-q)
      dimension a(la,0:*),x(*)
c  scalar product with column i of A
      ds_aiscpr=ds_scpr(b,a(1,i),x,n)
      return
      end

      function ds_daiscpr(n,a,la,i,x,b)
      implicit double precision (a-h,r-z), integer (i-q)
      dimension a(la,0:*),x(*)
      DOUBLE PRECISION ds_daiscpr,ds_dscpr
      ds_daiscpr=ds_dscpr(b,a(1,i),x,n)
      return
      end

      function ds_aiscpri(n,a,la,i,x,b,lr,li)
      implicit double precision (a-h,r-z), integer (i-q)
      dimension a(la,0:*),x(*),lr(*),li(*)
c  indirectly addressed scalar product with column i of A
      ds_aiscpri=ds_scpri(b,a(1,i),lr,x,n)
      return
      end

      function ds_daiscpri(n,a,la,i,x,b,lr,li)
      implicit double precision (a-h,r-z), integer (i-q)
      dimension a(la,0:*),x(*),lr(*),li(*)
      DOUBLE PRECISION ds_daiscpri,ds_dscpri
      ds_daiscpri=ds_dscpri(b,a(1,i),lr,x,n)
      return
      end

      function ds_aiscpri1(n,a,la,i,x,b,lr,li,m1)
      implicit double precision (a-h,r-z), integer (i-q)
      dimension a(la,0:*),x(*),lr(*),li(*)
c  indirectly addressed scalar product with column i of A_1
      ds_aiscpri1=ds_scpri(b,a(1,i),lr,x,m1)
      return
      end

      function ds_aiscpri2(n,a,la,i,x,b,lr,li,m1)
      implicit double precision (a-h,r-z), integer (i-q)
      dimension a(la,0:*),x(*),lr(*),li(*)
c  indirectly addressed scalar product with column i of A_2
      ds_aiscpri2=ds_scpri(b,a(1,i),lr(m1+1),x(m1+1),n-m1)
      return
      end

      function ds_ailen(n,a,la,i)
      implicit double precision (a-h,r-z), integer (i-q)
      dimension a(la,0:*)
c  L2 length of column i of A
      ds_ailen=ds_scpr(0.D0,a(1,i),a(1,i),n)
      ds_ailen=sqrt(ds_ailen)
      return
      end

      subroutine ds_iscatter(a,la,i,li,an,n)
      implicit double precision (a-h,r-z), integer (i-q)
...
c  indirect scatter into vector an
      ...
      subroutine ds_iunscatter(a,la,i,li,an,n)
      implicit double precision (a-h,r-z), integer (i-q)
      dimension a(la,0:*),li(*),an(*)
...
c  get element A(i,j)
      ...
      subroutine ds_setaij(aij,i,j,a,la)
...
c  set element A(i,j)
      ...
      subroutine ds_isaxpy(a,x,lr,y,n)
      implicit double precision (a-h,r-z), integer (i-q)
      dimension x(*),lr(*),y(*)
c  saxpy with x indirectly addressed
      ...
      function ds_dscpr(a,x,y,n)
      implicit double precision (a-h,r-z), integer (i-q)
      dimension x(*),y(*)
      DOUBLE PRECISION ds_dscpr
      ds_dscpr=dble(a)
      do i=1,n
        ds_dscpr=ds_dscpr+dble(x(i))*dble(y(i))
      enddo
      return
      end

      function ds_scpri(a,x,lr,y,n)
      implicit double precision (a-h,r-z), integer (i-q)
      dimension x(*),lr(*),y(*)
c  scpr with x indirectly addressed
      ds_scpri=a
      do i=1,n
        ds_scpri=ds_scpri+x(lr(i))*y(i)
      enddo
      return
      end

      function ds_dscpri(a,x,lr,y,n)
      implicit double precision (a-h,r-z), integer (i-q)
      dimension x(*),lr(*),y(*)
      DOUBLE PRECISION ds_dscpri
      ds_dscpri=dble(a)
      do i=1,n
        ds_dscpri=ds_dscpri+dble(x(lr(i)))*dble(y(i))
      enddo
      return
      end

      subroutine ds_cscale(n,m,a,la,x,bl,bu,s,menu,ifail)
      implicit double precision (a-h,r-z), integer (i-q)
