...
c  Current version dated 31/01/07
      ...
      subroutine sp_saipy(s,a,la,i,y,n)
...
c  saxpy with column i of A
    ...
    4 format(A/(5E15.7))
      ...
      subroutine sp_msaipy(s,a,la,i,y,n)
      implicit double precision (a-h,o-z)
      dimension a(*),la(0:*),y(*)
...
c     subroutine sp_daipy(s,a,la,i,y,n)
...
c     end
      ...
      subroutine sp_isaipy(s,a,la,i,y,n,lr,li)
      implicit double precision (a-h,o-z)
...
c the old isaipy was what might be called isaipy2
      ...
      subroutine sp_isaipy1(s,a,la,i,y,n,lr,li,m1)
      implicit double precision (a-h,o-z)
      dimension a(*),la(0:*),y(*),lr(*),li(*)
...
c     subroutine sp_ssaipy(s,a,la,i,y,n)
...
c     end
      ...
      function sp_aiscpr(n,a,la,i,x,b)
      implicit double precision (a-h,o-z)
      dimension a(*),la(0:*),x(*)
c  scalar product with column i of A
      ...
      do j=la(jp),la(jp+1)-1
        ir=la(j)
        sp_aiscpr=sp_aiscpr+x(ir)*a(j)
      enddo
      return
      end

      function sp_daiscpr(n,a,la,i,x,b)
      implicit double precision (a-h,o-z)
      dimension a(*),la(0:*),x(*)
      ...
      do j=la(jp),la(jp+1)-1
        ir=la(j)
        sp_daiscpr=sp_daiscpr+dble(x(ir))*dble(a(j))
      enddo
      return
      end

      function sp_aiscpri(n,a,la,i,x,b,lr,li)
      implicit double precision (a-h,o-z)
...
c  indirectly addressed scalar product with column i of A
      ...
      do j=la(jp),la(jp+1)-1
        ir=li(la(j))
        sp_aiscpri=sp_aiscpri+x(ir)*a(j)
      enddo
      return
      end

      function sp_daiscpri(n,a,la,i,x,b,lr,li)
      implicit double precision (a-h,o-z)
      dimension a(*),la(0:*),x(*),lr(*),li(*)
      DOUBLE PRECISION sp_daiscpri
      sp_daiscpri=dble(b)
      jp=la(0)+i
      do j=la(jp),la(jp+1)-1
        ir=li(la(j))
        sp_daiscpri=sp_daiscpri+dble(x(ir))*dble(a(j))
      enddo
      return
      end
...
c the old aiscpri was what might be called aiscpri2
      ...
      function sp_aiscpri1(n,a,la,i,x,b,lr,li,m1)
      implicit double precision (a-h,o-z)
      dimension a(*),la(0:*),x(*),lr(*),li(*)
c  indirectly addressed scalar product with column i of A_1
      ...
      do j=la(jp),la(jp+1)-1
        ir=li(la(j))
        if(ir.le.m1) sp_aiscpri1 = sp_aiscpri1+x(ir)*a(j)
      enddo
      return
      end

      function sp_ailen(n,a,la,i)
      implicit double precision (a-h,o-z)
      dimension a(*),la(0:*)
c  L2 length of column i of A
      ...
      jp=la(0)+i
      do j=la(jp),la(jp+1)-1
        sp_ailen = sp_ailen+a(j)**2
      enddo
      sp_ailen = sqrt(sp_ailen)
      return
      end

      subroutine sp_iscatter(a,la,i,li,an,n)
      implicit double precision (a-h,o-z)
...
c  indirect scatter into previously zeroed vector an
      ...
      subroutine sp_iunscatter(a,la,i,li,an,n)
      implicit double precision (a-h,o-z)
      dimension a(*),la(0:*),li(*),an(*)
...
c  get element A(i,j)
      ...
      subroutine sp_setaij(aij,i,j,a,la)
      implicit double precision (a-h,o-z)
      dimension a(*),la(0:*)
c  set element A(i,j)
      jp=la(0)+j
      ...
      subroutine sp_cscale(n,m,a,la,x,bl,bu,s,menu,ifail)
      implicit double precision (a-h,o-z)
...
c         t=2.D0**nint(log(t)*z)
      ...
      subroutine sp_modify(n,m,sigma,s,a,la,maxa,iws)
      implicit double precision (a-h,o-z)
...
c     print 3,'la =',(la(i),i=1,la(la0+m1+m)-1)
    ...
    4 format(A/(5E15.7))
      ...
      subroutine sp_restore(n,m,a,la)
      implicit double precision (a-h,o-z)
      dimension a(*),la(0:*)
...
c     print 3,'la =',(la(i),i=1,la(la0+m+1)-1)
    ...
    4 format(A/(5E15.7))
      ...
      subroutine sp_extend_la(n,m,la,lax)
      implicit double precision (a-h,o-z)
...
c     print 3,'lax =',(lax(i),i=1,lax(lax0+m+m+1)-1)
    3 format(A/(20I4))
      ...
      subroutine sp_extend_a(n,m,a,la,ax,lax,s,sigma)
      implicit double precision (a-h,o-z)
