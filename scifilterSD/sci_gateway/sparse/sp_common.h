...
my_export void C2F(sp_filtersd)(int *,int *,double *,double *,double *,double *,char *,double *,double *,double *,int *,double *,int *,
...
my_export void C2F(sp_glcpd)(int *, int *, int *, int *, int * ,double *, int *, double *, double *, double *, double *, double *, double * , double *, double *, double *,
...
//                               n,     m,     k,     kmax,  maxg,  a,        la,    x,        bl,       bu,       f,        fmin,     g,         r,        w,        e,
my_export void C2F(sci_sp_glcpd)(int *, int *, int *, int *, int * ,double *, int *, double *, double *, double *, double *, double *, double * , double *, double *, double *,
				 int *, double *, int *, int *, int *, double *, int *, char *, double *, int *, double *, int *, int *, int *, int *,  int *, fobj_glcpd_ptr,  grad_glcpd_ptr);
//                               ls,    alp,      lp,    mlp,   peq,   ws,       lws,   cws,    v,        nv,    rgtol,    mode,  ifail, mxgr,  iprint, nout,  functions,       gradients
