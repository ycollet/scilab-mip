...
This toolbox allows you to use the (mixed integer) linear programming tools under scilab.

To use this toolbox under scilab: go into the sciglpk module installation directory and do a:
