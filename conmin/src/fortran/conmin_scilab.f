...
C     SOLUTION IS UNBOUNDED.
      ...
      CALL BASOUT(IO ,WTE ," ")
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,971) LINOBJ
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,972) NCON
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,973) NSIDE 
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      CALL BASOUT(IO ,WTE ," ")
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,974) 
...
C     ------------------------------------------------------------------
      ...
      IF (NSIDE.EQ.0.AND.NCON.EQ.0) THEN
         CALL BASOUT(IO ,WTE ," ")
         CALL BASOUT(IO ,WTE ," ")
c         CALL BASOUT(IO ,WTE ," ")
c         CALL BASOUT(IO ,WTE ," ")
        ...
        CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ENDIF
      IF (NSIDE.NE.0.OR.NCON.GT.0) THEN
         CALL BASOUT(IO ,WTE ," ")
         CALL BASOUT(IO ,WTE ," ")
c         CALL BASOUT(IO ,WTE ," ")
c         CALL BASOUT(IO ,WTE ," ")
      ...
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1241) IPRINT,NDV,ITMAX,NCON,NSIDE,ICNDIR,NSCAL,NFDG
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1242)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1243) LINOBJ,ITRM,N1,N2,N3,N4,N5 
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ...
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1261) CT,CTMIN,CTL,CTLMIN
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      CALL BASOUT(IO ,WTE ," ")
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1262) 
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1263) THETA,PHI,DELFUN,DABFUN
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ...
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1251) FDCH,FDCHM,ALPHAX,ABOBJ1 
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ...
      DO 170 I=1,NDV,6
      M1=MIN0(NDV,I+5)
      ITMP=MIN0(M1-I,ITRUNC)
      WRITE (BUFSTR,1010) I,(VLB(J),J=I,I+ITMP)
170   CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1280)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      DO 180 I=1,NDV,6
      M1=MIN0(NDV,I+5)
      ITMP=MIN0(M1-I,ITRUNC)
      WRITE (BUFSTR,1010) I,(VUB(J),J=I,I+ITMP)
180   CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
190   CONTINUE
      IF (NSCAL.GE.0) GO TO 200 
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1300)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ITMP=MIN0(NDV,ITRUNC)
      WRITE (BUFSTR,1460) (SCAL(I),I=1,ITMP)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
200   CONTINUE
      ...
      M1=MIN0(NCON,I+14)
      ITMP=MIN0(M1-I,ITRUNC)
      WRITE (BUFSTR,1030) I,(ISC(J),J=I,I+ITMP)
210   CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      GO TO 230 
220   IF (NLNC.EQ.NCON) THEN
         CALL BASOUT(IO ,WTE ," ")
         WRITE (BUFSTR,1040)
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ENDIF
...
240   G1(I)=X(I)*X1 
      ...
      M1=MIN0(NDV,I+5)
      ITMP=MIN0(M1-I,ITRUNC)
      WRITE (BUFSTR,1010) I,(G1(J),J=I,I+ITMP) 
250   CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ...
      M1=MIN0(NCON,I+5) 
      ITMP=MIN0(M1-I,ITRUNC)
      WRITE (BUFSTR,1010) I,(G(J),J=I,I+ITMP)
260   CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
270   CONTINUE
      IF (IPRINT.GT.1) THEN
         WRITE (BUFSTR,1360) 
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
...
c         CALL BASOUT(IO ,WTE ," ")
c         CALL BASOUT(IO ,WTE ," ")
         WRITE (BUFSTR,1310) ITER
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ENDIF
      IF (IPRINT.GT.3.AND.NCON.GT.0) THEN
         CALL BASOUT(IO ,WTE ," ")
         WRITE (BUFSTR,1320) CT,CTL,PHI
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ENDIF
      CTA=ABS(CT) 
...
450   M3=M2-N3
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1060) M1 
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      IF (M1.EQ.0) GO TO 460
      WRITE (BUFSTR,1070)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ITMP=MIN0(M1,ITRUNC)
      WRITE (BUFSTR,1480) (MS1(I),I=1,ITMP)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
 460  CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1080) M3 
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      IF (M3.EQ.0) GO TO 470
      WRITE (BUFSTR,1070)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      M3=N3+1 
      ITMP=MIN0(M2-M3,ITRUNC)
      WRITE (BUFSTR,1480) (MS1(I),I=M3,M3+ITMP) 
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
470   CONTINUE
C     ------------------------------------------------------------------
...
C     PRINT ACTIVE SIDE CONSTRAINT NUMBERS. 
      ...
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1090) M1 
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      IF (M1.EQ.0) GO TO 530
      WRITE (BUFSTR,1100)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ITMP=MIN0(M1,ITRUNC)
      WRITE(BUFSTR,1480) (MS1(J),J=1,ITMP)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
530   CONTINUE
C     PRINT GRADIENTS OF ACTIVE AND VIOLATED CONSTRAINTS. 
      ...
      M1=MIN0(NDV,I+5)
      ITMP=MIN0(M1-I,ITRUNC)
      WRITE (BUFSTR,1010) I,(DF(J),J=I,I+ITMP) 
540   CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ...
      ENDIF
      IF (M2.GT.0) THEN
         WRITE (BUFSTR,1000) M3
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ENDIF
      DO 550 K=1,NDV,6
      M1=MIN0(NDV,K+5)
      ITMP=MIN0(M1-K,ITRUNC)
      WRITE (BUFSTR,1010) K,(A(J,I),J=K,K+ITMP)
550   CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
560   WRITE (BUFSTR,1360)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
570   CONTINUE
C     ------------------------------------------------------------------
...
C     IF (NVC.EQ.0) NFEAS=0 
      ...
      M1=MIN0(NAC,I+5)
      ITMP=MIN0(M1-I,ITRUNC)
      WRITE (BUFSTR,1010) I,(A(NDV1,J),J=I,I+ITMP) 
590   CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1210) S(NDV1)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
600   CONTINUE
C     ------------------------------------------------------------------
...
640   CONTINUE
      ...
      M1=MIN0(NDV,I+5)
      ITMP=MIN0(M1-I,ITRUNC)
      WRITE (BUFSTR,1010) I,(S(J),J=I,I+ITMP)
650   CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1110)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1111) SLOPE,ALP
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
660   CONTINUE
...
C     PRINT MOVE PARAMETER, NEW X-VECTOR AND CONSTRAINTS. 
      ...
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1390) ALP
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
730   IF (IPRINT.LT.2) GO TO 800
      IF (OBJB.GT.0.) GO TO 740 
      IF (IPRINT.EQ.2) THEN
         CALL BASOUT(IO ,WTE ," ")
         WRITE (BUFSTR,1400) ITER,OBJ
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ENDIF
      IF (IPRINT.GT.2) THEN
         CALL BASOUT(IO ,WTE ," ")
         WRITE (BUFSTR,1410) OBJ 
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ENDIF
      GO TO 760 
740   IF (IPRINT.EQ.2) GO TO 750
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1420) OBJ
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      GO TO 760 
 750  CALL BASOUT(IO ,WTE ," ")
      CALL BASOUT(IO ,WTE ," ")
c      CALL BASOUT(IO ,WTE ," ")
c      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1430) ITER,OBJ 
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
 760  CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1450)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      DO 770 I=1,NDV
      FF1=1.
...
770   G1(I)=FF1*X(I)
      ...
      ITMP=MIN0(M1-I,ITRUNC)
      WRITE (BUFSTR,1010) I,(G1(J),J=I,I+ITMP) 
780   CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ...
      ITMP=MIN0(M1-I,ITRUNC)
      WRITE (BUFSTR,1010) I,(G(J),J=I,I+ITMP)
790   CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
800   CONTINUE
C 
...
c      CALL BASOUT(IO ,WTE ," ")
      ...
      M1=MIN0(NDV,I+5)
      ITMP=MIN0(M1-I,ITRUNC)
      WRITE (BUFSTR,1010) I,(X(J),J=I,I+ITMP)
840   CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ...
      ITMP=MIN0(M1-I,ITRUNC)
      WRITE (BUFSTR,1010) I,(G(J),J=I,I+ITMP)
850   CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
...
870   CONTINUE
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1060) NAC
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      IF (NAC.EQ.0) GO TO 880 
      WRITE (BUFSTR,1070)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ITMP=MIN0(NAC,ITRUNC)
      WRITE (BUFSTR,1480) (IC(J),J=1,ITMP)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
 880  CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1080) NVC
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      IF (NVC.EQ.0) GO TO 890 
      WRITE (BUFSTR,1070)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ITMP=MIN0(NVC,ITRUNC)
      WRITE (BUFSTR,1480) (MS1(J),J=1,ITMP)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
890   CONTINUE
900   CONTINUE
...
930   CONTINUE
      ...
      IF (ITER.GE.ITMAX) THEN
         ...
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ENDIF
      IF (NFEAS.GE.NFEASCT) THEN
         WRITE (BUFSTR,1170) 
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ENDIF
      IF (IOBJ.GE.ITRM) THEN 
         WRITE (BUFSTR,1180) ITRM 
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ENDIF
      IF (KOBJ.GE.ITRM) THEN
         WRITE (BUFSTR,1190) ITRM 
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ENDIF
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1200) ITER 
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      CALL BASOUT(IO ,WTE ," ")
      WRITE (BUFSTR,1510) NCAL(1)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      IF (NCON.GT.0) THEN
         CALL BASOUT(IO ,WTE ," ")
         WRITE (BUFSTR,1520) NCAL(1) 
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ENDIF
      IF (NFDG.NE.0) THEN
         CALL BASOUT(IO ,WTE ," ")
         WRITE (BUFSTR,1530) NCAL(2) 
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ENDIF
      IF (NCON.GT.0.AND.NFDG.EQ.1) THEN
         CALL BASOUT(IO ,WTE ," ")
         WRITE (BUFSTR,1540) NCAL(2) 
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ENDIF
C     ------------------------------------------------------------------
...
C 
 965  FORMAT (" ")
 970  FORMAT (5X,'A completely unconstrained function with a linear
     $ objective is specified')
 971  FORMAT (10X,'linobj =',I5)
 972  FORMAT (10X,'ncon   =',I5)
 973  FORMAT (10X,'nside  =',I5)
 974  FORMAT (5X,'Control returned to calling program')

 980  FORMAT (5X,'CONMIN has achieved a solution of obj less than -
     $1.0E+40')
 981  FORMAT (5X,'Solution appears to be unbounded')
 982  FORMAT (5X,'Optimization is terminated')

 990  FORMAT (5X,'Constraint number',I5) 
 1000 FORMAT (5X,'Side constraint on variable',I5) 
 1010 FORMAT (3X,I5,1H),2X,6E13.5)

 1020 FORMAT (5X,'Linear constraint identifiers (isc)')
 1021 FORMAT (5X,'Non-zero indicates linear constraint')

 1030 FORMAT (3X,I5,1H),2X,15I5)
 1040 FORMAT (5X,'All constraints are linear')
 1050 FORMAT (5X,'All constraints are non-linear')
 1060 FORMAT (5X,'There are ',I5,' active constraints')
      
 1070 FORMAT (5X,'Constraint numbers are ') 
      
 1080 FORMAT (5X,'There are ',I5,' violated constraints')
 1090 FORMAT (5X,'There are ',I5,' active side constraints')
      
 1100 FORMAT (5X,'Decision variables at lower or upper bounds, (minus in
     $dicates lower bound)')

 1110 FORMAT (5X,'One-dimensional search')
 1111 FORMAT (5X,'Initial slope =',E12.4,12X,'Proposed alpha =',E12.4) 

 1120 FORMAT (5X,'* * CONMIN Detects vlb(I) > vub(I)')
 1121 FORMAT (5X,'Fix is set x(I)=vlb(I)=vub(I) = .5*(vlb(I)+vub(I)
     $for I =',I5)

 1130 FORMAT (5X,'* * CONMIN detects initial x(I) < vlb(I)')
 1131 FORMAT (5X,'x(I) =',E12.4,2X,'vlb(I) =',E12.4)
 1132 FORMAT (5X,'x(I) is set equal to vlb(I) for I =',I5)

 1140 FORMAT (5X,'* * CONMIN detects initial x(I) > vub(I)')
 1141 FORMAT (5X,'x(I) =',E12.4,2X,'vub(I) =',E12.4)
 1142 FORMAT (5X,'x(I) is set equal to vub(I) for I =',I5)

 1150 FORMAT (5X,'Termination criterion') 

1160  FORMAT (10X,'Iter equals itmax') 
1170  FORMAT (10X,'nfeasct consecutive iterations failed to produce a 
     $feasible design')
1180  FORMAT (10X,'abs(1-obj(I-1)/obj(I)) less than delfun for',I3, 
     1' iterations') 
1190  FORMAT (10X,'abs(obj(I)-obj(I-1))   less than dabfun for',I3, 
     1' iterations') 

1200  FORMAT (5X,'Number of iterations =',I5) 
1210  FORMAT (5X,'Constraint parameter, beta =',E14.5)

 1220 FORMAT (' ')
 1221 FORMAT (12X,27('* '))
 1222 FORMAT (12X,'*',51X,'*')
 1223 FORMAT (12X,'*',20X,'C O NM I N ',20X,'*')
 1224 FORMAT (12X,'*',51X,'*')
 1225 FORMAT (12X,'*',15X,' FORTRAN program for ',15X,'*')
 1226 FORMAT (12X,'*',51X,'*')
 1227 FORMAT (12X,'*',9X,'CONstrained function MINimization',9X,'*')
 1228 FORMAT (12X,'*',51X,'*')
 1229 FORMAT (12X,27('* ')) 

 1230 FORMAT (5X,'Constrained function minimization')
 1231 FORMAT (5X,'Control parameters')

 1240 FORMAT (5X,'iprint  ndv    itmax    ncon    nside  icndir   nscal
     $   nfdg')
 1241 FORMAT (8I8)
 1242 FORMAT (5X,'linobj  itrm',5X,'n1',6X,'n2',6X,'n3',6X,'n4',
     16X,'n5')
 1243 FORMAT (7I8)

 1250 FORMAT (9X,'fdch',12X,'fdchm',11X,'alphax',10X,'abobj1')
 1251 FORMAT (1X,4(2X,E14.5))

 1260 FORMAT (9X,'ct',14X,'ctmin',11X,'ctl',13X,'ctlmin')
 1261 FORMAT (1X,4(2X,E14.5))
 1262 FORMAT (9X,'theta',11X,'phi',13X,'delfun',10X,'dabfun')
 1263 FORMAT (1X,4(2X,E14.5))

 1270 FORMAT (5X,'Lower bounds on decision variables (vlb)')
 1280 FORMAT (5X,'Upper bounds on decision variables (vub)')

 1290 FORMAT (5X,'Unconstrained function minimization')
 1291 FORMAT (5X,'Control parameters')

1300  FORMAT (5X,'Scaling vector (scal)') 
1310  FORMAT (5X,'Begin iteration number',I5)
1320  FORMAT (5X,'ct =',E14.5,5X,'ctl =',E14.5,5X,'phi =',E14.5) 
1330  FORMAT (5X,'New scaling vector (scal)') 
1340  FORMAT (5X,'Gradient of obj') 
1350  FORMAT (5X,'Gradient of active and violated constraints')
1360  FORMAT (' ')
1370  FORMAT (5X,'Push-off factors, (theta(I), I=1,nac)') 
1380  FORMAT (5X,'Search direction (S-vector)') 
1390  FORMAT (5X,'Calculated alpha =',E14.5)
1400  FORMAT (5X,'Iter =',I5,5X,'obj =',E14.5,5X,'no change in obj') 
1410  FORMAT (5X,'obj =',E15.6,5X,'no change in obj') 
1420  FORMAT (5X,'obj =',E15.6)
1430  FORMAT (5X,'Iter =',I5,5X,'obj =',E14.5)

 1440 FORMAT (5X,'Initial function information')
 1441 FORMAT (5X,'obj =',E15.6) 

 1450 FORMAT (5X,'Decision variables (X-vector)') 
1460  FORMAT (3X,7E13.4)
1470  FORMAT (5X,'Constraint values (G-vector)')
1480  FORMAT (5X,15I5)

 1490 FORMAT (5X,'The number of active and violated constraints excee
     $ds n3-1.')
 1491 FORMAT (5X,'Dimensioned size of matrices A and B and vector IC 
     $is insufficient')
 1492 FORMAT (5X,'Optimization terminated and control returned
     $ to main program.')

 1500 FORMAT (' ')
 1501 FORMAT (4X,'Final optimization information') 

1510  FORMAT (5X,'Objective function was evaluated',8X,I5,2X,'times') 
1520  FORMAT (5X,'Constraint functions were evaluated',I10,2X,'times')
1530  FORMAT (5X,'Gradient of objective was calculated',I9,2X,'times')
1540  FORMAT (5X,'Gradients of constraints were calculated',I5,2X,'times
     $')
      END
...
C 
C 
 360  FORMAT (5X,'* * * unconstrained one-dimensional search info
     $rmation * * *')
 370  FORMAT (5X,'alpha =',E14.5)
 371  FORMAT (5X,'X-vector')
 380  FORMAT (5X,6E13.5)
 390  FORMAT (5X,'obj =',E14.5)
      END
...
C     ZERO GRADIENT IS FOUND.  WRITE ERROR MESSAGE. 
      IF(IPRINT.GE.2) THEN
         WRITE(BUFSTR,43)IC(I)
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
         CALL BASOUT(IO ,WTE ," ")
         WRITE(BUFSTR,430)
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ENDIF
 43   FORMAT(5X,'** constraint',I5,' has zero gradient')
 430  FORMAT(5X,'deleted from active set')
C     REDUCE NAC BY ONE.
      NAC=NAC-1 
...
C     ------------------------------------------------------------------
      ...
      IF (IPRINT.GT.1.AND.NER.GT.0) THEN
         CALL BASOUT(IO ,WTE ," ")
         CALL BASOUT(IO ,WTE ," ")
         WRITE (BUFSTR,180) 
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
...
C     S-VECTOR IS NOT FEASIBLE DUE TO SOME NUMERICAL PROBLEM. 
      IF(IPRINT.GE.2) THEN
         ...
         CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      ENDIF
 178  FORMAT(5X,'** calculated S-vector is not feasible')
 1780 FORMAT(5X,'beta is set to zero')
      S(NDV1)=0.
      NVC=0 
      RETURN
179   CONTINUE
...
C 
C 
 180  FORMAT (5X,'* * direction finding process did not converge')
 181  FORMAT (5X,'* * S-vector may not be valid') 
      END
...
110   G(I)=SCAL(I)*X(I) 
      ITMP=MIN0(NDV,ITRUNC)
      WRITE (BUFSTR,750) (G(I),I=1,ITMP)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
      GO TO 130 
120   ITMP=MIN0(NDV,ITRUNC)
      WRITE (BUFSTR,750) (X(I),I=1,ITMP)
      CALL BASOUT(IO ,WTE ,BUFSTR(1:LNBLNK(BUFSTR)))
C     ------------------------------------------------------------------
...
C 
C 
 720  FORMAT (5X,'Three-point interpolation') 
 730  FORMAT ('* * * constrained one-dimensional search informati
     $on * * *') 
 740  FORMAT (5X,'Proposed design')
 741  FORMAT (5X,'alpha =',E12.5)
 742  FORMAT (5X,'X-vector') 
 750  FORMAT (1X,8E12.4)
 760  FORMAT (5X,'obj =',E13.5)
 770  FORMAT (5X,'Constraint values') 
 780  FORMAT (5X,'Two-point interpolation') 
 790  FORMAT (5X,'* * * end of one-dimensional search') 
      END
...
C SET FUNCTIONS
      ...
      SUBROUTINE SET_DELFUN(DELFUNIN)
      IMPLICIT           DOUBLE PRECISION(a-h,o-z)
      COMMON /CNMN1/ DELFUN,DABFUN,FDCH,FDCHM,CT,CTMIN,CTL,CTLMIN,ALPHAX
     1,ABOBJ1,THETA,OBJ,NDV,NCON,NSIDE,IPRINT,NFDG,NSCAL,LINOBJ,ITMAX,IT
     2RM,ICNDIR,IGOTO,NAC,INFO,INFOG,ITER
      ...
      SUBROUTINE SET_DABFUN(DABFUNIN)
      IMPLICIT           DOUBLE PRECISION(a-h,o-z)
      COMMON /CNMN1/ DELFUN,DABFUN,FDCH,FDCHM,CT,CTMIN,CTL,CTLMIN,ALPHAX
     1,ABOBJ1,THETA,OBJ,NDV,NCON,NSIDE,IPRINT,NFDG,NSCAL,LINOBJ,ITMAX,IT
     2RM,ICNDIR,IGOTO,NAC,INFO,INFOG,ITER
     ...
     2RM,ICNDIR,IGOTO,NAC,INFO,INFOG,ITER
      ...
      SUBROUTINE SET_CTLMIN(CTLMININ)
      IMPLICIT           DOUBLE PRECISION(a-h,o-z)
      COMMON /CNMN1/ DELFUN,DABFUN,FDCH,FDCHM,CT,CTMIN,CTL,CTLMIN,ALPHAX
     1,ABOBJ1,THETA,OBJ,NDV,NCON,NSIDE,IPRINT,NFDG,NSCAL,LINOBJ,ITMAX,IT
     2RM,ICNDIR,IGOTO,NAC,INFO,INFOG,ITER
      ...
      SUBROUTINE SET_ALPHAX(ALPHAXIN)
      IMPLICIT           DOUBLE PRECISION(a-h,o-z)
      COMMON /CNMN1/ DELFUN,DABFUN,FDCH,FDCHM,CT,CTMIN,CTL,CTLMIN,ALPHAX
     1,ABOBJ1,THETA,OBJ,NDV,NCON,NSIDE,IPRINT,NFDG,NSCAL,LINOBJ,ITMAX,IT
     2RM,ICNDIR,IGOTO,NAC,INFO,INFOG,ITER
      ...
      SUBROUTINE SET_ABOBJ1(ABOBJ1IN)
      IMPLICIT           DOUBLE PRECISION(a-h,o-z)
      COMMON /CNMN1/ DELFUN,DABFUN,FDCH,FDCHM,CT,CTMIN,CTL,CTLMIN,ALPHAX
     1,ABOBJ1,THETA,OBJ,NDV,NCON,NSIDE,IPRINT,NFDG,NSCAL,LINOBJ,ITMAX,IT
     2RM,ICNDIR,IGOTO,NAC,INFO,INFOG,ITER
     ...
     2RM,ICNDIR,IGOTO,NAC,INFO,INFOG,ITER
      ...
      SUBROUTINE SET_IPRINT(IPRINTIN)
      IMPLICIT           DOUBLE PRECISION(a-h,o-z)
      COMMON /CNMN1/ DELFUN,DABFUN,FDCH,FDCHM,CT,CTMIN,CTL,CTLMIN,ALPHAX
     1,ABOBJ1,THETA,OBJ,NDV,NCON,NSIDE,IPRINT,NFDG,NSCAL,LINOBJ,ITMAX,IT
     2RM,ICNDIR,IGOTO,NAC,INFO,INFOG,ITER
     ...
     2RM,ICNDIR,IGOTO,NAC,INFO,INFOG,ITER
      ...
      SUBROUTINE SET_LINOBJ(LINOBJIN)
      IMPLICIT           DOUBLE PRECISION(a-h,o-z)
      COMMON /CNMN1/ DELFUN,DABFUN,FDCH,FDCHM,CT,CTMIN,CTL,CTLMIN,ALPHAX
     1,ABOBJ1,THETA,OBJ,NDV,NCON,NSIDE,IPRINT,NFDG,NSCAL,LINOBJ,ITMAX,IT
     2RM,ICNDIR,IGOTO,NAC,INFO,INFOG,ITER
     ...
     2RM,ICNDIR,IGOTO,NAC,INFO,INFOG,ITER
      ...
      SUBROUTINE SET_ICNDIR(ICNDIRIN)
      IMPLICIT           DOUBLE PRECISION(a-h,o-z)
      COMMON /CNMN1/ DELFUN,DABFUN,FDCH,FDCHM,CT,CTMIN,CTL,CTLMIN,ALPHAX
     1,ABOBJ1,THETA,OBJ,NDV,NCON,NSIDE,IPRINT,NFDG,NSCAL,LINOBJ,ITMAX,IT
     2RM,ICNDIR,IGOTO,NAC,INFO,INFOG,ITER
