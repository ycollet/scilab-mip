...
// ********************* Eigenvalue/Singular Value Decomposition Drivers
  ...
  void F77NAME(zgesvd)(char *jobu, char *jobvt, integer *m, integer *n, doublecomplex *a, integer *lda, double *sing, doublecomplex *u, integer *ldu, doublecomplex *vt, integer *ldvt, integer *info);
