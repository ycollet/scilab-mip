...
params = add_param(params, 'max_consecutive_infeasible', 0);
params = add_param(params, 'num_resolve_at_infeasibles', 0);
params = add_param(params, 'num_resolve_at_node', 0);
params = add_param(params, 'num_resolve_at_root', 0);
...
params = add_param(params, 'bb_log_interval', 100);
...
params = add_param(params, 'lp_log_level', 0);
