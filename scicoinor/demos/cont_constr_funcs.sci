...
function [diff_bound] = df_elec_on_sph_eq(x)
// xi^2 + yi^2 + zi^2 = 1 (nb_var equality constraints)
nb_var = size(x,1)*size(x,2);
Index = 1;
diff_bound = [];
for i=1:size(x,1)
  diff_bound(Index,:)     = spzeros(1,nb_var);
  diff_bound(Index,3*(i-1)+1) = 2*x(i,1);
  diff_bound(Index,3*(i-1)+2) = 2*x(i,2);
  diff_bound(Index,3*(i-1)+3) = 2*x(i,3);
  Index = Index + 1;
end
endfunction
...
function [diff_bound] = vv_open_eq(r)
diff_bound = 0;
endfunction
...
function y = dfsp_1_df_obj(x)
y = derivative(dfsp_1_obj,x);
endfunction

function y = dfsp_1_ineq(x)
y = exp(-sin(3*x(1))) - 1/10*(x(1) - 1/2)^2 - 1;
endfunction
function y = dfsp_1_df_ineq(x)
y = derivative(dfsp_1_ineq,x);
endfunction

function y = dfsp_1_eq(x)
y = 0;
endfunction
function y = dfsp_1_df_eq(x)
y = 0;
endfunction
...
function y = dfsp_2_df_obj(x)
y = derivative(dfsp_2_obj,x);
endfunction

function y = dfsp_2_ineq(x)
y = 1/20 - exp(-2/5*(x(1)+5))*sin(4/5*%pi*(x(1)+5));
endfunction
function y = dfsp_2_df_ineq(x)
y = derivative(dfsp_2_ineq,x);
endfunction

function y = dfsp_2_eq(x)
y = 0;
endfunction
function y = dfsp_2_df_eq(x)
y = 0;
endfunction
...
function y = dfsp_3_df_obj(x)
y = derivative(dfsp_3_obj,x);
endfunction

function y = dfsp_3_ineq(x)
y = 3/2*(cos(7/20*(x(1)+10)) - sin(7/4*(x(1) + 10)) + 1/2);
endfunction
function y = dfsp_3_df_ineq(x)
y = derivative(dfsp_3_ineq,x);
endfunction

function y = dfsp_3_eq(x)
y = 0;
endfunction
function y = dfsp_3_df_eq(x)
y = 0;
endfunction
...
function y = dfsp_4_df_obj(x)
y = derivative(dfsp_4_obj,x);
endfunction
...
function y = dfsp_4_df_ineq(x)
y = derivative(dfsp_4_ineq,x);
endfunction

function y = dfsp_4_eq(x)
y = 0;
endfunction
function y = dfsp_4_df_eq(x)
y = 0;
endfunction
...
function y = dfsp_5_df_obj(x)
y = derivative(dfsp_5_obj,x);
endfunction
...
function y = dfsp_5_df_ineq(x)
y = derivative(dfsp_5_ineq,x);
endfunction

function y = dfsp_5_eq(x)
y = 0;
endfunction
function y = dfsp_5_df_eq(x)
y = 0;
endfunction
...
function y = dfsp_6_df_obj(x)
y = derivative(dfsp_6_obj,x);
endfunction
...
function y = dfsp_6_df_ineq(x)
y = derivative(dfsp_6_ineq,x);
endfunction

function y = dfsp_6_eq(x)
y = 0;
endfunction
function y = dfsp_6_df_eq(x)
y = 0;
endfunction
...
function y = dfsp_7_df_obj(x)
y = derivative(dfsp_7_obj,x);
endfunction
...
function y = dfsp_7_df_ineq(x)
y = derivative(dfsp_7_ineq,x);
endfunction

function y = dfsp_7_eq(x)
y = 0;
endfunction
function y = dfsp_7_df_eq(x)
y = 0;
endfunction
...
function y = dfsp_8_df_obj(x)
y = derivative(dfsp_8_obj,x);
endfunction
...
function y = dfsp_8_df_ineq(x)
y = derivative(dfsp_8_ineq,x);
endfunction

function y = dfsp_8_eq(x)
y = 0;
endfunction
function y = dfsp_8_df_eq(x)
y = 0;
endfunction
...
function y = dfsp_9_df_obj(x)
y = derivative(dfsp_9_obj,x);
endfunction
...
function y = dfsp_9_df_ineq(x)
y = derivative(dfsp_9_ineq,x);
endfunction

function y = dfsp_9_eq(x)
y = 0;
endfunction
function y = dfsp_9_df_eq(x)
y = 0;
endfunction
...
function y = dfsp_10_df_obj(x)
y = derivative(dfsp_10_obj,x);
endfunction
...
function y = dfsp_10_df_ineq(x)
y = derivative(dfsp_10_ineq,x);
endfunction

function y = dfsp_10_eq(x)
y = 0;
endfunction
function y = dfsp_10_df_eq(x)
y = 0;
endfunction
...
function y = dfsp_11_df_obj(x)
y = derivative(dfsp_11_obj,x);
endfunction
...
function y = dfsp_11_df_ineq(x)
y = derivative(dfsp_11_ineq,x);
endfunction

function y = dfsp_11_eq(x)
y = 0;
endfunction
function y = dfsp_11_df_eq(x)
y = 0;
endfunction
...
function y = ndfsp_1_df_obj(x)
y = derivative(ndfsp_1_obj,x);
endfunction

function y = ndfsp_1_ineq(x)
y(1,1) = abs(sin(7/554*(69*x(1) + 347)) + cos(7/554*(69*x(1) + 347))) + cos(21/554*(69*x(1) + 347));
endfunction
function y = ndfsp_1_df_ineq(x)
y = derivative(ndfsp_1_ineq,x);
endfunction

function y = ndfsp_1_eq(x)
y = 0;
endfunction
function y = ndfsp_1_df_eq(x)
y = 0;
endfunction
...
function y = ndfsp_2_df_obj(x)
y = derivative(ndfsp_2_obj,x);
endfunction

function y = ndfsp_2_ineq(x)
y(1,1) = abs(sin(2*x(1))^3 + cos(x(1))^3) - 2/5;
endfunction
function y = ndfsp_2_df_ineq(x)
y = derivative(ndfsp_2_ineq,x);
endfunction

function y = ndfsp_2_eq(x)
y = 0;
endfunction
function y = ndfsp_2_df_eq(x)
y = 0;
endfunction
...
function y = ndfsp_3_df_obj(x)
y = derivative(ndfsp_3_obj,x);
endfunction

function y = ndfsp_3_ineq(x)
y(1,1) = 3/2 - cos(6*(x(1) - 5))*abs(2*(x(1) - 5)*sin(2*(x(1) - 5)));
endfunction
function y = ndfsp_3_df_ineq(x)
y = derivative(ndfsp_3_ineq,x);
endfunction

function y = ndfsp_3_eq(x)
y = 0;
endfunction
function y = ndfsp_3_df_eq(x)
y = 0;
endfunction
...
function y = ndfsp_4_df_obj(x)
y = derivative(ndfsp_4_obj,x);
endfunction
...
function y = ndfsp_4_df_ineq(x)
y = derivative(ndfsp_4_ineq,x);
endfunction

function y = ndfsp_4_eq(x)
y = 0;
endfunction
function y = ndfsp_4_df_eq(x)
y = 0;
endfunction
...
function y = ndfsp_5_df_obj(x)
y = derivative(ndfsp_5_obj,x);
endfunction
...
function y = ndfsp_5_df_ineq(x)
y = derivative(ndfsp_5_ineq,x);
endfunction

function y = ndfsp_5_eq(x)
y = 0;
endfunction
function y = ndfsp_5_df_eq(x)
y = 0;
endfunction
...
function y = ndfsp_6_df_obj(x)
y = derivative(ndfsp_6_obj,x);
endfunction
...
function y = ndfsp_6_df_ineq(x)
y = derivative(ndfsp_6_ineq,x);
endfunction

function y = ndfsp_6_eq(x)
y = 0;
endfunction
function y = ndfsp_6_df_eq(x)
y = 0;
endfunction
...
function y = ndfsp_7_df_obj(x)
y = derivative(ndfsp_7_obj,x);
endfunction
...
function y = ndfsp_7_df_ineq(x)
y = derivative(ndfsp_7_ineq,x);
endfunction

function y = ndfsp_7_eq(x)
y = 0;
endfunction
function y = ndfsp_7_df_eq(x)
y = 0;
endfunction
...
function y = ndfsp_8_df_obj(x)
y = derivative(ndfsp_8_obj,x);
endfunction
...
function y = ndfsp_8_df_ineq(x)
y = derivative(ndfsp_8_ineq,x);
endfunction

function y = ndfsp_8_eq(x)
y = 0;
endfunction
function y = ndfsp_8_df_eq(x)
y = 0;
endfunction
...
function y = ndfsp_9_df_obj(x)
y = derivative(ndfsp_9_obj,x);
endfunction
...
function y = ndfsp_9_df_ineq(x)
y = derivative(ndfsp_9_ineq,x);
endfunction

function y = ndfsp_9_eq(x)
y = 0;
endfunction
function y = ndfsp_9_df_eq(x)
y = 0;
endfunction
...
function y = ndfsp_10_df_obj(x)
y = derivative(ndfsp_10_obj,x);
endfunction
...
function y = ndfsp_10_df_ineq(x)
y = derivative(ndfsp_10_ineq,x);
endfunction

function y = ndfsp_10_eq(x)
y = 0;
endfunction
function y = ndfsp_10_df_eq(x)
y = 0;
endfunction
...
function y = ndfsp_11_df_obj(x)
y = derivative(ndfsp_11_obj,x);
endfunction
...
function y = ndfsp_11_df_ineq(x)
y = derivative(ndfsp_11_ineq,x);
endfunction

function y = ndfsp_11_eq(x)
y = 0;
endfunction
function y = ndfsp_11_df_eq(x)
y = 0;
endfunction
