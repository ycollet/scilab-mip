...
void export_ddU_x_Matlab(LL_Lolimot * Lolimot, ofstream & F_Lolimot,
			 unsigned int VarNb1, unsigned int VarNb2, const string & VarName);
void export_ddV_x_Matlab(LL_Lolimot * Lolimot, ofstream & F_Lolimot,
			 unsigned int VarNb1, unsigned int VarNb2, const string & VarName);
void export_ddV_x_Matlab_Text(LL_Lolimot * Lolimot, ofstream & F_Lolimot, const string & ParamName1, 
			      const string & ParamName2, const string & VarType, const string & VarName);
void export_ddU_x_Matlab_Text(LL_Lolimot * Lolimot, ofstream & F_Lolimot, const string & ParamName1, 
			      const string & ParamName2, const string & VarType, const string & VarName);
