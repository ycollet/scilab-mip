...
void export_Destroy_Matlab(LL_Lolimot * Lolimot, 
			   ofstream & F_Lolimot)
{
...
void export_Init_Data_Matlab(LL_Lolimot * Lolimot, 
			     ofstream & F_Lolimot)
{
...
void export_Destroy_Data_Matlab(LL_Lolimot * Lolimot, 
				ofstream & F_Lolimot)
{
...
void export_Declare_Variable_Matlab(LL_Lolimot * Lolimot, 
				    ofstream & F_Lolimot, 
...
void export_Data_Matlab_Text(LL_Lolimot * Lolimot, 
			     ofstream & F_Lolimot)
{
...
void export_dV_x_Matlab_Text(LL_Lolimot * Lolimot, 
			     ofstream & F_Lolimot, 
...
void export_dU_x_Matlab_Text(LL_Lolimot * Lolimot, 
			     ofstream & F_Lolimot, 
			     const string & ParamName, 
			     const string & VarName)
{
...
void export_Init_Matlab(LL_Lolimot * Lolimot, 
			ofstream & F_Lolimot)
{
  unsigned int nbPartition = Lolimot->getPartitionSet().size();
...
void export_Ei_x_Matlab(LL_Lolimot * Lolimot, 
			ofstream & F_Lolimot)
{
  unsigned int   noPartition, nbPartition = Lolimot->getPartitionSet().size();
  unsigned int   noDimension, nbDimension = Lolimot->getDimensionSet().size();
...
void export_Li_x_Matlab(LL_Lolimot * Lolimot, 
			ofstream & F_Lolimot)
{
  unsigned int   noPartition, nbPartition = Lolimot->getPartitionSet().size();
  unsigned int   noDimension, nbDimension = Lolimot->getDimensionSet().size();
...
void export_U_x_Matlab(LL_Lolimot * Lolimot, 
		       ofstream & F_Lolimot, 
		       const string & VarName)
{
  unsigned int   noPartition, nbPartition = Lolimot->getPartitionSet().size();
...
void export_V_x_Matlab(LL_Lolimot * Lolimot, 
		       ofstream & F_Lolimot, 
		       const string & VarName)
{
  unsigned int   noPartition, nbPartition = Lolimot->getPartitionSet().size();
...
void export_dU_x_Matlab(LL_Lolimot * Lolimot, 
			ofstream & F_Lolimot, 
			unsigned int VarNb1, 
			const string & VarName)
{
...
void export_dV_x_Matlab(LL_Lolimot * Lolimot, 
			ofstream & F_Lolimot, 
			unsigned int VarNb1, 
			const string & VarName)
{
...
void export_List_Partitions_Matlab(LL_Lolimot * Lolimot, 
				   ofstream & F_Lolimot)
{
  unsigned int   noPartition, nbPartition = Lolimot->getPartitionSet().size();
  LL_Partition * curPartition = NULL;
...
void export_List_Variables_Matlab(LL_Lolimot * Lolimot, 
				  ofstream & F_Lolimot)
{
  unsigned int noDimension, nbDimension = Lolimot->getDimensionSet().size();
...
void export_ddU_x_Matlab(LL_Lolimot * Lolimot, 
			 ofstream & F_Lolimot, 
			 unsigned int VarNb1, 
			 unsigned int VarNb2, 
			 const string & VarName)
...
void export_ddV_x_Matlab(LL_Lolimot * Lolimot, 
			 ofstream & F_Lolimot, 
			 unsigned int VarNb1, 
			 unsigned int VarNb2, 
			 const string & VarName)
...
void export_ddU_x_Matlab_Text(LL_Lolimot * Lolimot, 
			      ofstream & F_Lolimot,
			      const string & ParamName1, 
			      const string & ParamName2, 
			      const string & VarName)
{
  unsigned int   noPartition, nbPartition = Lolimot->getPartitionSet().size();
  LL_Partition * curPartition = NULL;
...
void export_ddV_x_Matlab_Text(LL_Lolimot * Lolimot, 
			      ofstream & F_Lolimot, 
			      const string & ParamName1, 
			      const string & ParamName2, 
			      const string & VarName)
...
bool exportFunctionInMatlab(LL_Lolimot * Lolimot, 
...
bool exportDerivativeFunctionInMatlab(LL_Lolimot * Lolimot, 
				      const string & nameFunction,
				      unsigned int VarNb, 
				      const vector<Model_Input> & ListInput)
{
...
bool exportDerivativeFunctionInMatlab2(LL_Lolimot * Lolimot, 
				       const string & nameFunction,
				       const vector<Model_Input> & ListInput)
{
...
bool exportSecondDerivativeFunctionInMatlab(LL_Lolimot * Lolimot, 
					    const string & nameFunction, 
					    unsigned int VarNb1, 
					    unsigned int VarNb2, 
					    const vector<Model_Input> & ListInput)
...
bool exportSecondDerivativeFunctionInMatlab2(LL_Lolimot * Lolimot, 
					     const string & nameFunction, 
					     const vector<Model_Input> & ListInput)
{
  unsigned int   noPartition, nbPartition = Lolimot->getPartitionSet().size();
