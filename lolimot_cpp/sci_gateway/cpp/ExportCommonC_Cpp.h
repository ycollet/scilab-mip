...
void export_dU_x_C(LL_Lolimot * Lolimot, ofstream & F_Lolimot,
		   unsigned int VarNb1, const string & VarType, const string & VarName);
void export_dV_x_C(LL_Lolimot * Lolimot, ofstream & F_Lolimot,
		   unsigned int VarNb1, const string & VarType, const string & VarName);
void export_Data_C_Text(LL_Lolimot * Lolimot, ofstream & F_Lolimot, const string & VarType);
void export_dV_x_C_Text(LL_Lolimot * Lolimot, ofstream & F_Lolimot,
			const string & ParamNam, const string & VarType, const string & VarName);
void export_dU_x_C_Text(LL_Lolimot * Lolimot, ofstream & F_Lolimot, 
			const string & ParamNam, const string & VarType, const string & VarName);
...
void export_ddV_x_C(LL_Lolimot * Lolimot, ofstream & F_Lolimot, unsigned int VarNb1, unsigned int VarNb2,
		    const string & VarType, const string & VarName);
void export_ddU_x_C_Text(LL_Lolimot * Lolimot, ofstream & F_Lolimot,
			 const string & ParamName1, const string & ParamName2,
			 const string & VarType, const string & VarName);
void export_ddV_x_C_Text(LL_Lolimot * Lolimot, ofstream & F_Lolimot, 
			 const string & ParamName1, const string & ParamName2, 
			 const string & VarType, const string & VarName);
#endif
