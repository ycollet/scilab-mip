...
%% Measure - [-1 1]
 ...
 dV = 0.0;
 dV = dV - ((x(2) - 0) / 0.4356) * Ei(1);
 dV = dV - ((x(2) - -0.666667) / 0.0484) * Ei(2);
 dV = dV - ((x(2) - -0.111111) / 0.0215111) * Ei(3);
 dV = dV - ((x(2) - 0.555556) / 0.0860445) * Ei(4);
 dV = dV - ((x(2) - 0) / 0.4356) * Ei(5);
 dV = dV - ((x(2) - -0.888889) / 0.00537778) * Ei(6);
 dV = dV - ((x(2) - -0.703704) / 0.00239012) * Ei(7);
 dV = dV - ((x(2) - -0.259259) / 0.00239012) * Ei(8);
 dV = dV - ((x(2) - 0.555556) / 0.0860445) * Ei(9);
 dV = dV - ((x(2) - -0.613169) / 0.000118031) * Ei(10);
 dV = dV - ((x(2) - -0.037037) / 0.00956049) * Ei(11);
 dV = dV - ((x(2) - -0.432099) / 0.00424911) * Ei(12);
 dV = dV - ((x(2) - -0.432099) / 0.00424911) * Ei(13);
 dV = dV - ((x(2) - -0.037037) / 0.00956049) * Ei(14);
 dV = dV - ((x(2) - -0.432099) / 0.00424911) * Ei(15);
 dV = dV - ((x(2) - 0.555556) / 0.0860445) * Ei(16);
 dV = dV - ((x(2) - -0.037037) / 0.00956049) * Ei(17);
 dV = dV - ((x(2) - 0.555556) / 0.0860445) * Ei(18);
 dV = dV - ((x(2) - -0.666667) / 0.0484) * Ei(19);
 dV = dV - ((x(2) - -0.259259) / 0.00239012) * Ei(20);
 dV = dV - ((x(2) - -0.888889) / 0.00537778) * Ei(21);
 dV = dV - ((x(2) - -0.888889) / 0.00537778) * Ei(22);
 dV = dV - ((x(2) - -0.259259) / 0.00239012) * Ei(23);
 dV = dV - ((x(2) - -0.753086) / 0.00026557) * Ei(24);
 dV = dV - ((x(2) - -0.888889) / 0.00537778) * Ei(25);
 dV = dV - ((x(2) - -0.679012) / 0.00106228) * Ei(26);
 dV = dV - ((x(2) - 0) / 0.4356) * Ei(27);
 dV = dV - ((x(2) - -0.679012) / 0.00106228) * Ei(28);
 dV = dV - ((x(2) - -0.585734) / 5.24581e-05) * Ei(29);
 dV = dV - ((x(2) - -0.552812) / 0.000209833) * Ei(30);
 ...
 dU = 0.0;
 dU = dU + (0.991035 - ((x(2) - 0) / 0.4356) * Li(1)) * Ei(1);
 dU = dU + (0.967875 - ((x(2) - -0.666667) / 0.0484) * Li(2)) * Ei(2);
 dU = dU + (1.00248 - ((x(2) - -0.111111) / 0.0215111) * Li(3)) * Ei(3);
 dU = dU + (0.993099 - ((x(2) - 0.555556) / 0.0860445) * Li(4)) * Ei(4);
 dU = dU + (1.03233 - ((x(2) - 0) / 0.4356) * Li(5)) * Ei(5);
 dU = dU + (0.953868 - ((x(2) - -0.888889) / 0.00537778) * Li(6)) * Ei(6);
 dU = dU + (0.974689 - ((x(2) - -0.703704) / 0.00239012) * Li(7)) * Ei(7);
 dU = dU + (0.972573 - ((x(2) - -0.259259) / 0.00239012) * Li(8)) * Ei(8);
 dU = dU + (0.980401 - ((x(2) - 0.555556) / 0.0860445) * Li(9)) * Ei(9);
 dU = dU + (1.09248 - ((x(2) - -0.613169) / 0.000118031) * Li(10)) * Ei(10);
 dU = dU + (0.990434 - ((x(2) - -0.037037) / 0.00956049) * Li(11)) * Ei(11);
 dU = dU + (1.0109 - ((x(2) - -0.432099) / 0.00424911) * Li(12)) * Ei(12);
 dU = dU + (0.993938 - ((x(2) - -0.432099) / 0.00424911) * Li(13)) * Ei(13);
 dU = dU + (0.999673 - ((x(2) - -0.037037) / 0.00956049) * Li(14)) * Ei(14);
 dU = dU + (1.01348 - ((x(2) - -0.432099) / 0.00424911) * Li(15)) * Ei(15);
 dU = dU + (1.00644 - ((x(2) - 0.555556) / 0.0860445) * Li(16)) * Ei(16);
 dU = dU + (0.99922 - ((x(2) - -0.037037) / 0.00956049) * Li(17)) * Ei(17);
 dU = dU + (1.02342 - ((x(2) - 0.555556) / 0.0860445) * Li(18)) * Ei(18);
 dU = dU + (1.01202 - ((x(2) - -0.666667) / 0.0484) * Li(19)) * Ei(19);
 dU = dU + (0.996558 - ((x(2) - -0.259259) / 0.00239012) * Li(20)) * Ei(20);
 dU = dU + (0.979475 - ((x(2) - -0.888889) / 0.00537778) * Li(21)) * Ei(21);
 dU = dU + (0.969202 - ((x(2) - -0.888889) / 0.00537778) * Li(22)) * Ei(22);
 dU = dU + (1.0064 - ((x(2) - -0.259259) / 0.00239012) * Li(23)) * Ei(23);
 dU = dU + (0.972939 - ((x(2) - -0.753086) / 0.00026557) * Li(24)) * Ei(24);
 dU = dU + (1.03568 - ((x(2) - -0.888889) / 0.00537778) * Li(25)) * Ei(25);
 dU = dU + (0.988424 - ((x(2) - -0.679012) / 0.00106228) * Li(26)) * Ei(26);
 dU = dU + (1.00141 - ((x(2) - 0) / 0.4356) * Li(27)) * Ei(27);
 dU = dU + (1.02471 - ((x(2) - -0.679012) / 0.00106228) * Li(28)) * Ei(28);
 dU = dU + (0.996492 - ((x(2) - -0.585734) / 5.24581e-05) * Li(29)) * Ei(29);
 dU = dU + (0.942638 - ((x(2) - -0.552812) / 0.000209833) * Li(30)) * Ei(30);
  clear Ei;
  clear Li;
    res = ((dU*V-dV*U)/(V*V));
