...
%% Measure - [-1 1]
 ...
 ddV = 0.0;
 ddV = ddV - (1.0 / 1344.44 - ((x(1) - 55.5556) / 1344.44)^2.0) * Ei(1);
 ddV = ddV - (1.0 / 597.531 - ((x(1) - 370.37) / 597.531)^2.0) * Ei(2);
 ddV = ddV - (1.0 / 5377.78 - ((x(1) - 444.444) / 5377.78)^2.0) * Ei(3);
 ddV = ddV - (1.0 / 5377.78 - ((x(1) - 444.444) / 5377.78)^2.0) * Ei(4);
 ddV = ddV - (1.0 / 597.531 - ((x(1) - 148.148) / 597.531)^2.0) * Ei(5);
 ddV = ddV - (1.0 / 2390.12 - ((x(1) - 629.63) / 2390.12)^2.0) * Ei(6);
 ddV = ddV - (1.0 / 2390.12 - ((x(1) - 629.63) / 2390.12)^2.0) * Ei(7);
 ddV = ddV - (1.0 / 2390.12 - ((x(1) - 629.63) / 2390.12)^2.0) * Ei(8);
 ddV = ddV - (1.0 / 265.569 - ((x(1) - 580.247) / 265.569)^2.0) * Ei(9);
 ddV = ddV - (1.0 / 21511.1 - ((x(1) - 777.778) / 21511.1)^2.0) * Ei(10);
 ddV = ddV - (1.0 / 2390.12 - ((x(1) - 629.63) / 2390.12)^2.0) * Ei(11);
 ddV = ddV - (1.0 / 2390.12 - ((x(1) - 629.63) / 2390.12)^2.0) * Ei(12);
 ddV = ddV - (1.0 / 1062.28 - ((x(1) - 753.086) / 1062.28)^2.0) * Ei(13);
 ddV = ddV - (1.0 / 1062.28 - ((x(1) - 753.086) / 1062.28)^2.0) * Ei(14);
 ddV = ddV - (1.0 / 4249.11 - ((x(1) - 901.235) / 4249.11)^2.0) * Ei(15);
 ddV = ddV - (1.0 / 9560.5 - ((x(1) - 851.852) / 9560.5)^2.0) * Ei(16);
 ddV = ddV - (1.0 / 4249.11 - ((x(1) - 901.235) / 4249.11)^2.0) * Ei(17);
 ddV = ddV - (1.0 / 1062.28 - ((x(1) - 654.321) / 1062.28)^2.0) * Ei(18);
 ddV = ddV - (1.0 / 2390.12 - ((x(1) - 481.481) / 2390.12)^2.0) * Ei(19);
 ddV = ddV - (1.0 / 1062.28 - ((x(1) - 753.086) / 1062.28)^2.0) * Ei(20);
 ddV = ddV - (1.0 / 1062.28 - ((x(1) - 753.086) / 1062.28)^2.0) * Ei(21);
 ddV = ddV - (1.0 / 472.123 - ((x(1) - 835.391) / 472.123)^2.0) * Ei(22);
 ddV = ddV - (1.0 / 4249.11 - ((x(1) - 901.235) / 4249.11)^2.0) * Ei(23);
 ddV = ddV - (1.0 / 9560.5 - ((x(1) - 851.852) / 9560.5)^2.0) * Ei(24);
 ddV = ddV - (1.0 / 1888.49 - ((x(1) - 934.156) / 1888.49)^2.0) * Ei(25);
 ddV = ddV - (1.0 / 1062.28 - ((x(1) - 753.086) / 1062.28)^2.0) * Ei(26);
 ddV = ddV - (1.0 / 2390.12 - ((x(1) - 259.259) / 2390.12)^2.0) * Ei(27);
 ddV = ddV - (1.0 / 4249.11 - ((x(1) - 901.235) / 4249.11)^2.0) * Ei(28);
 ddV = ddV - (1.0 / 21511.1 - ((x(1) - 777.778) / 21511.1)^2.0) * Ei(29);
 ddV = ddV - (1.0 / 21511.1 - ((x(1) - 777.778) / 21511.1)^2.0) * Ei(30);
 ...
 ddU = 0.0;
 ddU = ddU - (Li(1) / 1344.44 + 2 * 0 * ((x(1) - 55.5556) / 1344.44) - Li(1) * ((x(1) - 55.5556) / 1344.44)^2.0) * Ei(1);
 ddU = ddU - (Li(2) / 597.531 + 2 * 0 * ((x(1) - 370.37) / 597.531) - Li(2) * ((x(1) - 370.37) / 597.531)^2.0) * Ei(2);
 ddU = ddU - (Li(3) / 5377.78 + 2 * 0 * ((x(1) - 444.444) / 5377.78) - Li(3) * ((x(1) - 444.444) / 5377.78)^2.0) * Ei(3);
 ddU = ddU - (Li(4) / 5377.78 + 2 * 0 * ((x(1) - 444.444) / 5377.78) - Li(4) * ((x(1) - 444.444) / 5377.78)^2.0) * Ei(4);
 ddU = ddU - (Li(5) / 597.531 + 2 * 0 * ((x(1) - 148.148) / 597.531) - Li(5) * ((x(1) - 148.148) / 597.531)^2.0) * Ei(5);
 ddU = ddU - (Li(6) / 2390.12 + 2 * 0 * ((x(1) - 629.63) / 2390.12) - Li(6) * ((x(1) - 629.63) / 2390.12)^2.0) * Ei(6);
 ddU = ddU - (Li(7) / 2390.12 + 2 * 0 * ((x(1) - 629.63) / 2390.12) - Li(7) * ((x(1) - 629.63) / 2390.12)^2.0) * Ei(7);
 ddU = ddU - (Li(8) / 2390.12 + 2 * 0 * ((x(1) - 629.63) / 2390.12) - Li(8) * ((x(1) - 629.63) / 2390.12)^2.0) * Ei(8);
 ddU = ddU - (Li(9) / 265.569 + 2 * 0 * ((x(1) - 580.247) / 265.569) - Li(9) * ((x(1) - 580.247) / 265.569)^2.0) * Ei(9);
 ddU = ddU - (Li(10) / 21511.1 + 2 * 0 * ((x(1) - 777.778) / 21511.1) - Li(10) * ((x(1) - 777.778) / 21511.1)^2.0) * Ei(10);
 ddU = ddU - (Li(11) / 2390.12 + 2 * 0 * ((x(1) - 629.63) / 2390.12) - Li(11) * ((x(1) - 629.63) / 2390.12)^2.0) * Ei(11);
 ddU = ddU - (Li(12) / 2390.12 + 2 * 0 * ((x(1) - 629.63) / 2390.12) - Li(12) * ((x(1) - 629.63) / 2390.12)^2.0) * Ei(12);
 ddU = ddU - (Li(13) / 1062.28 + 2 * 0 * ((x(1) - 753.086) / 1062.28) - Li(13) * ((x(1) - 753.086) / 1062.28)^2.0) * Ei(13);
 ddU = ddU - (Li(14) / 1062.28 + 2 * 0 * ((x(1) - 753.086) / 1062.28) - Li(14) * ((x(1) - 753.086) / 1062.28)^2.0) * Ei(14);
 ddU = ddU - (Li(15) / 4249.11 + 2 * 0 * ((x(1) - 901.235) / 4249.11) - Li(15) * ((x(1) - 901.235) / 4249.11)^2.0) * Ei(15);
 ddU = ddU - (Li(16) / 9560.5 + 2 * 0 * ((x(1) - 851.852) / 9560.5) - Li(16) * ((x(1) - 851.852) / 9560.5)^2.0) * Ei(16);
 ddU = ddU - (Li(17) / 4249.11 + 2 * 0 * ((x(1) - 901.235) / 4249.11) - Li(17) * ((x(1) - 901.235) / 4249.11)^2.0) * Ei(17);
 ddU = ddU - (Li(18) / 1062.28 + 2 * 0 * ((x(1) - 654.321) / 1062.28) - Li(18) * ((x(1) - 654.321) / 1062.28)^2.0) * Ei(18);
 ddU = ddU - (Li(19) / 2390.12 + 2 * 0 * ((x(1) - 481.481) / 2390.12) - Li(19) * ((x(1) - 481.481) / 2390.12)^2.0) * Ei(19);
 ddU = ddU - (Li(20) / 1062.28 + 2 * 0 * ((x(1) - 753.086) / 1062.28) - Li(20) * ((x(1) - 753.086) / 1062.28)^2.0) * Ei(20);
 ddU = ddU - (Li(21) / 1062.28 + 2 * 0 * ((x(1) - 753.086) / 1062.28) - Li(21) * ((x(1) - 753.086) / 1062.28)^2.0) * Ei(21);
 ddU = ddU - (Li(22) / 472.123 + 2 * 0 * ((x(1) - 835.391) / 472.123) - Li(22) * ((x(1) - 835.391) / 472.123)^2.0) * Ei(22);
 ddU = ddU - (Li(23) / 4249.11 + 2 * 0 * ((x(1) - 901.235) / 4249.11) - Li(23) * ((x(1) - 901.235) / 4249.11)^2.0) * Ei(23);
 ddU = ddU - (Li(24) / 9560.5 + 2 * 0 * ((x(1) - 851.852) / 9560.5) - Li(24) * ((x(1) - 851.852) / 9560.5)^2.0) * Ei(24);
 ddU = ddU - (Li(25) / 1888.49 + 2 * 0 * ((x(1) - 934.156) / 1888.49) - Li(25) * ((x(1) - 934.156) / 1888.49)^2.0) * Ei(25);
 ddU = ddU - (Li(26) / 1062.28 + 2 * 0 * ((x(1) - 753.086) / 1062.28) - Li(26) * ((x(1) - 753.086) / 1062.28)^2.0) * Ei(26);
 ddU = ddU - (Li(27) / 2390.12 + 2 * 0 * ((x(1) - 259.259) / 2390.12) - Li(27) * ((x(1) - 259.259) / 2390.12)^2.0) * Ei(27);
 ddU = ddU - (Li(28) / 4249.11 + 2 * 0 * ((x(1) - 901.235) / 4249.11) - Li(28) * ((x(1) - 901.235) / 4249.11)^2.0) * Ei(28);
 ddU = ddU - (Li(29) / 21511.1 + 2 * 0 * ((x(1) - 777.778) / 21511.1) - Li(29) * ((x(1) - 777.778) / 21511.1)^2.0) * Ei(29);
 ddU = ddU - (Li(30) / 21511.1 + 2 * 0 * ((x(1) - 777.778) / 21511.1) - Li(30) * ((x(1) - 777.778) / 21511.1)^2.0) * Ei(30);
  clear Ei;
  clear Li;
