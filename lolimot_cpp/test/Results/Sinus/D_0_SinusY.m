...
%% Measure - [-1 1]
 ...
 dV = 0.0;
 dV = dV - ((x(1) - 55.5556) / 1344.44) * Ei(1);
 dV = dV - ((x(1) - 370.37) / 597.531) * Ei(2);
 dV = dV - ((x(1) - 444.444) / 5377.78) * Ei(3);
 dV = dV - ((x(1) - 444.444) / 5377.78) * Ei(4);
 dV = dV - ((x(1) - 148.148) / 597.531) * Ei(5);
 dV = dV - ((x(1) - 629.63) / 2390.12) * Ei(6);
 dV = dV - ((x(1) - 629.63) / 2390.12) * Ei(7);
 dV = dV - ((x(1) - 629.63) / 2390.12) * Ei(8);
 dV = dV - ((x(1) - 580.247) / 265.569) * Ei(9);
 dV = dV - ((x(1) - 777.778) / 21511.1) * Ei(10);
 dV = dV - ((x(1) - 629.63) / 2390.12) * Ei(11);
 dV = dV - ((x(1) - 629.63) / 2390.12) * Ei(12);
 dV = dV - ((x(1) - 753.086) / 1062.28) * Ei(13);
 dV = dV - ((x(1) - 753.086) / 1062.28) * Ei(14);
 dV = dV - ((x(1) - 901.235) / 4249.11) * Ei(15);
 dV = dV - ((x(1) - 851.852) / 9560.5) * Ei(16);
 dV = dV - ((x(1) - 901.235) / 4249.11) * Ei(17);
 dV = dV - ((x(1) - 654.321) / 1062.28) * Ei(18);
 dV = dV - ((x(1) - 481.481) / 2390.12) * Ei(19);
 dV = dV - ((x(1) - 753.086) / 1062.28) * Ei(20);
 dV = dV - ((x(1) - 753.086) / 1062.28) * Ei(21);
 dV = dV - ((x(1) - 835.391) / 472.123) * Ei(22);
 dV = dV - ((x(1) - 901.235) / 4249.11) * Ei(23);
 dV = dV - ((x(1) - 851.852) / 9560.5) * Ei(24);
 dV = dV - ((x(1) - 934.156) / 1888.49) * Ei(25);
 dV = dV - ((x(1) - 753.086) / 1062.28) * Ei(26);
 dV = dV - ((x(1) - 259.259) / 2390.12) * Ei(27);
 dV = dV - ((x(1) - 901.235) / 4249.11) * Ei(28);
 dV = dV - ((x(1) - 777.778) / 21511.1) * Ei(29);
 dV = dV - ((x(1) - 777.778) / 21511.1) * Ei(30);
 ...
 dU = 0.0;
 dU = dU + (0 - ((x(1) - 55.5556) / 1344.44) * Li(1)) * Ei(1);
 dU = dU + (0 - ((x(1) - 370.37) / 597.531) * Li(2)) * Ei(2);
 dU = dU + (0 - ((x(1) - 444.444) / 5377.78) * Li(3)) * Ei(3);
 dU = dU + (0 - ((x(1) - 444.444) / 5377.78) * Li(4)) * Ei(4);
 dU = dU + (0 - ((x(1) - 148.148) / 597.531) * Li(5)) * Ei(5);
 dU = dU + (0 - ((x(1) - 629.63) / 2390.12) * Li(6)) * Ei(6);
 dU = dU + (0 - ((x(1) - 629.63) / 2390.12) * Li(7)) * Ei(7);
 dU = dU + (0 - ((x(1) - 629.63) / 2390.12) * Li(8)) * Ei(8);
 dU = dU + (0 - ((x(1) - 580.247) / 265.569) * Li(9)) * Ei(9);
 dU = dU + (0 - ((x(1) - 777.778) / 21511.1) * Li(10)) * Ei(10);
 dU = dU + (0 - ((x(1) - 629.63) / 2390.12) * Li(11)) * Ei(11);
 dU = dU + (0 - ((x(1) - 629.63) / 2390.12) * Li(12)) * Ei(12);
 dU = dU + (0 - ((x(1) - 753.086) / 1062.28) * Li(13)) * Ei(13);
 dU = dU + (0 - ((x(1) - 753.086) / 1062.28) * Li(14)) * Ei(14);
 dU = dU + (0 - ((x(1) - 901.235) / 4249.11) * Li(15)) * Ei(15);
 dU = dU + (0 - ((x(1) - 851.852) / 9560.5) * Li(16)) * Ei(16);
 dU = dU + (0 - ((x(1) - 901.235) / 4249.11) * Li(17)) * Ei(17);
 dU = dU + (0 - ((x(1) - 654.321) / 1062.28) * Li(18)) * Ei(18);
 dU = dU + (0 - ((x(1) - 481.481) / 2390.12) * Li(19)) * Ei(19);
 dU = dU + (0 - ((x(1) - 753.086) / 1062.28) * Li(20)) * Ei(20);
 dU = dU + (0 - ((x(1) - 753.086) / 1062.28) * Li(21)) * Ei(21);
 dU = dU + (0 - ((x(1) - 835.391) / 472.123) * Li(22)) * Ei(22);
 dU = dU + (0 - ((x(1) - 901.235) / 4249.11) * Li(23)) * Ei(23);
 dU = dU + (0 - ((x(1) - 851.852) / 9560.5) * Li(24)) * Ei(24);
 dU = dU + (0 - ((x(1) - 934.156) / 1888.49) * Li(25)) * Ei(25);
 dU = dU + (0 - ((x(1) - 753.086) / 1062.28) * Li(26)) * Ei(26);
 dU = dU + (0 - ((x(1) - 259.259) / 2390.12) * Li(27)) * Ei(27);
 dU = dU + (0 - ((x(1) - 901.235) / 4249.11) * Li(28)) * Ei(28);
 dU = dU + (0 - ((x(1) - 777.778) / 21511.1) * Li(29)) * Ei(29);
 dU = dU + (0 - ((x(1) - 777.778) / 21511.1) * Li(30)) * Ei(30);
  clear Ei;
  clear Li;
    res = ((dU*V-dV*U)/(V*V));
