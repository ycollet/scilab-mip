...
This toolbox allows you to use read / write various file format
related to linear programming under scilab.

To use this toolbox under scilab: go into the scicoinutils module installation directory and do a:
