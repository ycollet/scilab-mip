function sivp_xmltohtml(dirs,titles,xsl,step)
...
// updated by Shiqi Yu on July 10, 2005
  ...
  select LANGUAGE 
   ...
   case 'fr'  then H= 'Chapitre de help'
	case 'zh-s' then H= '°ïÖúÄ¿Â¼'
	case 'zh-t' then H= 'ŽÍÖúÄ¿ '
  end
  // get man_dirs 
...
//-------------------------------------
  ...
  select LANGUAGE 
   ...
   case 'zh-s' then title =  "<H2>Scilabº¯Êý</H2>";
   case 'zh-t' then title =  "<H2>Scilabº¯”µ</H2>";
  end
