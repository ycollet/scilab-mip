...
extern int structnnz(int n, int k, struct blockmatrix C, struct constraintmatrix * constraints);
extern int actnnz(int n, int lda, double A[]);
extern int bandwidth(int n, int lda, double A[]);

int sci_easy_sdp(n,k,C,a,constraints,constant_offset,pX,py,pZ,ppobj,pdobj,params,printlevel)
     int n;
     int k;
     ...
     int printlevel;
{
  ...
  double *workvec1 = NULL;
  double *workvec2 = NULL;
  double *workvec3 = NULL;
  double *workvec4 = NULL;
  double *workvec5 = NULL;
  double *workvec6 = NULL;
  double *workvec7 = NULL;
  double *workvec8 = NULL;
  double *diagO = NULL; 
  double *Fp = NULL;
  double *O = NULL;
  double *dy = NULL;
  ...
  double *besty = NULL;
  int ldam;
  struct sparseblock **byblocks = NULL;
  struct sparseblock *ptr = NULL;
  struct sparseblock *oldptr = NULL;
  int i;
  int j;
  int blk;
  struct sparseblock *p = NULL;
  struct sparseblock *q = NULL;
